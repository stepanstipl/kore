...
var (
	...
	generatorName   = kingpin.Flag("generator", "generator name to write in the generated file").Default("").Short('g').String()
...
func main() {
	...
	if generatorName == nil || *generatorName == "" {
		tmp := strings.Join(os.Args, " ")
		generatorName = &tmp
	}

	var resultSrc bytes.Buffer
	resultSrc.WriteString(fmt.Sprintf("// Code generated by %s; DO NOT EDIT.\n", *generatorName))
