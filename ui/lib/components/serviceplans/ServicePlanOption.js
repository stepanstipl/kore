...
class ServicePlanOption extends React.Component {
  static propTypes = {
  ...
  render() {
    ...
    // Special handling for object types - represent as a card with a service plan option for each property:
...
export default ServicePlanOption
