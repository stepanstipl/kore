...
import V1IDPClientSpec from './V1IDPClientSpec';
import V1IDPClientStatus from './V1IDPClientStatus';
import V1ObjectMeta from './V1ObjectMeta';

/**
 * The V1IDPClient model module.
 * @module model/V1IDPClient
 * @version 0.0.1
 */
class V1IDPClient {
    /**
     * Constructs a new <code>V1IDPClient</code>.
     * @alias module:model/V1IDPClient
     */
    constructor() { 
        
        V1IDPClient.initialize(this);
    }
    ...
    /**
     * Constructs a <code>V1IDPClient</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/V1IDPClient} obj Optional instance to populate.
     * @return {module:model/V1IDPClient} The populated <code>V1IDPClient</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new V1IDPClient();
            ...
            if (data.hasOwnProperty('spec')) {
                obj['spec'] = V1IDPClientSpec.constructFromObject(data['spec']);
            }
            if (data.hasOwnProperty('status')) {
                obj['status'] = V1IDPClientStatus.constructFromObject(data['status']);
            }
        }
        return obj;
    }
...
/**
     * @return {module:model/V1IDPClientSpec}
     */
    getSpec() {
        return this.spec;
    }
    ...
    /**
     * @param {module:model/V1IDPClientSpec} spec
     */
    setSpec(spec) {
        this['spec'] = spec;
    }
/**
     * @return {module:model/V1IDPClientStatus}
     */
    getStatus() {
        return this.status;
    }
    ...
    /**
     * @param {module:model/V1IDPClientStatus} status
     */
    setStatus(status) {
        this['status'] = status;
    }
 ...
 */
V1IDPClient.prototype['apiVersion'] = undefined;

/**
 * Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
 * @member {String} kind
 */
V1IDPClient.prototype['kind'] = undefined;

/**
 * @member {module:model/V1ObjectMeta} metadata
 */
V1IDPClient.prototype['metadata'] = undefined;

/**
 * @member {module:model/V1IDPClientSpec} spec
 */
V1IDPClient.prototype['spec'] = undefined;

/**
 * @member {module:model/V1IDPClientStatus} status
 */
V1IDPClient.prototype['status'] = undefined;
