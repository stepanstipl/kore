...
import V1NamespaceClaim from './V1NamespaceClaim';

/**
 * The V1NamespaceClaimList model module.
 * @module model/V1NamespaceClaimList
 * @version 0.0.1
 */
class V1NamespaceClaimList {
    /**
     * Constructs a new <code>V1NamespaceClaimList</code>.
     * @alias module:model/V1NamespaceClaimList
     * @param items {Array.<module:model/V1NamespaceClaim>} 
     */
    constructor(items) { 
        
        V1NamespaceClaimList.initialize(this, items);
    }
    ...
    /**
     * Constructs a <code>V1NamespaceClaimList</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/V1NamespaceClaimList} obj Optional instance to populate.
     * @return {module:model/V1NamespaceClaimList} The populated <code>V1NamespaceClaimList</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new V1NamespaceClaimList();

            if (data.hasOwnProperty('apiVersion')) {
                obj['apiVersion'] = ApiClient.convertToType(data['apiVersion'], 'String');
            }
            if (data.hasOwnProperty('items')) {
                obj['items'] = ApiClient.convertToType(data['items'], [V1NamespaceClaim]);
            }
...
/**
     * @return {Array.<module:model/V1NamespaceClaim>}
     */
    getItems() {
        return this.items;
    }
    ...
    /**
     * @param {Array.<module:model/V1NamespaceClaim>} items
     */
    setItems(items) {
        this['items'] = items;
    }
 ...
 */
V1NamespaceClaimList.prototype['apiVersion'] = undefined;

/**
 * @member {Array.<module:model/V1NamespaceClaim>} items
 */
V1NamespaceClaimList.prototype['items'] = undefined;

/**
 * Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
 * @member {String} kind
 */
V1NamespaceClaimList.prototype['kind'] = undefined;

/**
 * @member {module:model/V1ListMeta} metadata
 */
V1NamespaceClaimList.prototype['metadata'] = undefined;
...
export default V1NamespaceClaimList;
