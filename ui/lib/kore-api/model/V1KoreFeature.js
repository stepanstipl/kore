...
import V1KoreFeatureSpec from './V1KoreFeatureSpec';
import V1KoreFeatureStatus from './V1KoreFeatureStatus';
import V1ObjectMeta from './V1ObjectMeta';

/**
 * The V1KoreFeature model module.
 * @module model/V1KoreFeature
 * @version 0.0.1
 */
class V1KoreFeature {
    /**
     * Constructs a new <code>V1KoreFeature</code>.
     * @alias module:model/V1KoreFeature
     */
    constructor() { 
        
        V1KoreFeature.initialize(this);
    }
    ...
    /**
     * Constructs a <code>V1KoreFeature</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/V1KoreFeature} obj Optional instance to populate.
     * @return {module:model/V1KoreFeature} The populated <code>V1KoreFeature</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new V1KoreFeature();
            ...
            if (data.hasOwnProperty('spec')) {
                obj['spec'] = V1KoreFeatureSpec.constructFromObject(data['spec']);
            }
            if (data.hasOwnProperty('status')) {
                obj['status'] = V1KoreFeatureStatus.constructFromObject(data['status']);
            }
        }
        return obj;
    }
...
/**
     * @return {module:model/V1KoreFeatureSpec}
     */
    getSpec() {
        return this.spec;
    }
    ...
    /**
     * @param {module:model/V1KoreFeatureSpec} spec
     */
    setSpec(spec) {
        this['spec'] = spec;
    }
/**
     * @return {module:model/V1KoreFeatureStatus}
     */
    getStatus() {
        return this.status;
    }
    ...
    /**
     * @param {module:model/V1KoreFeatureStatus} status
     */
    setStatus(status) {
        this['status'] = status;
    }
 ...
 */
V1KoreFeature.prototype['apiVersion'] = undefined;

/**
 * Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
 * @member {String} kind
 */
V1KoreFeature.prototype['kind'] = undefined;

/**
 * @member {module:model/V1ObjectMeta} metadata
 */
V1KoreFeature.prototype['metadata'] = undefined;

/**
 * @member {module:model/V1KoreFeatureSpec} spec
 */
V1KoreFeature.prototype['spec'] = undefined;

/**
 * @member {module:model/V1KoreFeatureStatus} status
 */
V1KoreFeature.prototype['status'] = undefined;
