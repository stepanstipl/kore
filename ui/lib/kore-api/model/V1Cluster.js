...
import V1ClusterSpec from './V1ClusterSpec';
import V1ClusterStatus from './V1ClusterStatus';
import V1ObjectMeta from './V1ObjectMeta';

/**
 * The V1Cluster model module.
 * @module model/V1Cluster
 * @version 0.0.1
 */
class V1Cluster {
    /**
     * Constructs a new <code>V1Cluster</code>.
     * @alias module:model/V1Cluster
     */
    constructor() { 
        
        V1Cluster.initialize(this);
    }
    ...
    /**
     * Constructs a <code>V1Cluster</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/V1Cluster} obj Optional instance to populate.
     * @return {module:model/V1Cluster} The populated <code>V1Cluster</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new V1Cluster();
            ...
            if (data.hasOwnProperty('spec')) {
                obj['spec'] = V1ClusterSpec.constructFromObject(data['spec']);
            }
            if (data.hasOwnProperty('status')) {
                obj['status'] = V1ClusterStatus.constructFromObject(data['status']);
            }
        }
        return obj;
    }
...
/**
     * @return {module:model/V1ClusterSpec}
     */
    getSpec() {
        return this.spec;
    }
    ...
    /**
     * @param {module:model/V1ClusterSpec} spec
     */
    setSpec(spec) {
        this['spec'] = spec;
    }
/**
     * @return {module:model/V1ClusterStatus}
     */
    getStatus() {
        return this.status;
    }
    ...
    /**
     * @param {module:model/V1ClusterStatus} status
     */
    setStatus(status) {
        this['status'] = status;
    }
 ...
 */
V1Cluster.prototype['apiVersion'] = undefined;

/**
 * Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
 * @member {String} kind
 */
V1Cluster.prototype['kind'] = undefined;

/**
 * @member {module:model/V1ObjectMeta} metadata
 */
V1Cluster.prototype['metadata'] = undefined;

/**
 * @member {module:model/V1ClusterSpec} spec
 */
V1Cluster.prototype['spec'] = undefined;

/**
 * @member {module:model/V1ClusterStatus} status
 */
V1Cluster.prototype['status'] = undefined;
