...
import V1AuditEvent from './V1AuditEvent';
import V1ListMeta from './V1ListMeta';

/**
 * The V1AuditEventList model module.
 * @module model/V1AuditEventList
 * @version 0.0.1
 */
class V1AuditEventList {
    /**
     * Constructs a new <code>V1AuditEventList</code>.
     * @alias module:model/V1AuditEventList
     * @param items {Array.<module:model/V1AuditEvent>} 
     */
    constructor(items) { 
        
        V1AuditEventList.initialize(this, items);
    }
    ...
    /**
     * Constructs a <code>V1AuditEventList</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/V1AuditEventList} obj Optional instance to populate.
     * @return {module:model/V1AuditEventList} The populated <code>V1AuditEventList</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new V1AuditEventList();

            if (data.hasOwnProperty('apiVersion')) {
                obj['apiVersion'] = ApiClient.convertToType(data['apiVersion'], 'String');
            }
            if (data.hasOwnProperty('items')) {
                obj['items'] = ApiClient.convertToType(data['items'], [V1AuditEvent]);
            }
...
/**
     * @return {Array.<module:model/V1AuditEvent>}
     */
    getItems() {
        return this.items;
    }
    ...
    /**
     * @param {Array.<module:model/V1AuditEvent>} items
     */
    setItems(items) {
        this['items'] = items;
    }
 ...
 */
V1AuditEventList.prototype['apiVersion'] = undefined;

/**
 * @member {Array.<module:model/V1AuditEvent>} items
 */
V1AuditEventList.prototype['items'] = undefined;

/**
 * Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
 * @member {String} kind
 */
V1AuditEventList.prototype['kind'] = undefined;

/**
 * @member {module:model/V1ListMeta} metadata
 */
V1AuditEventList.prototype['metadata'] = undefined;
...
export default V1AuditEventList;
