...
import V1alpha1ProjectClaimSpec from './V1alpha1ProjectClaimSpec';
import V1alpha1ProjectClaimStatus from './V1alpha1ProjectClaimStatus';

/**
 * The V1alpha1ProjectClaim model module.
 * @module model/V1alpha1ProjectClaim
 * @version 0.0.1
 */
class V1alpha1ProjectClaim {
    /**
     * Constructs a new <code>V1alpha1ProjectClaim</code>.
     * @alias module:model/V1alpha1ProjectClaim
     */
    constructor() { 
        
        V1alpha1ProjectClaim.initialize(this);
    }
    ...
    /**
     * Constructs a <code>V1alpha1ProjectClaim</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/V1alpha1ProjectClaim} obj Optional instance to populate.
     * @return {module:model/V1alpha1ProjectClaim} The populated <code>V1alpha1ProjectClaim</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new V1alpha1ProjectClaim();
            ...
            if (data.hasOwnProperty('spec')) {
                obj['spec'] = V1alpha1ProjectClaimSpec.constructFromObject(data['spec']);
            }
            if (data.hasOwnProperty('status')) {
                obj['status'] = V1alpha1ProjectClaimStatus.constructFromObject(data['status']);
            }
        }
        return obj;
    }
...
/**
     * @return {module:model/V1alpha1ProjectClaimSpec}
     */
    getSpec() {
        return this.spec;
    }
    ...
    /**
     * @param {module:model/V1alpha1ProjectClaimSpec} spec
     */
    setSpec(spec) {
        this['spec'] = spec;
    }
/**
     * @return {module:model/V1alpha1ProjectClaimStatus}
     */
    getStatus() {
        return this.status;
    }
    ...
    /**
     * @param {module:model/V1alpha1ProjectClaimStatus} status
     */
    setStatus(status) {
        this['status'] = status;
    }
 ...
 */
V1alpha1ProjectClaim.prototype['apiVersion'] = undefined;

/**
 * Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
 * @member {String} kind
 */
V1alpha1ProjectClaim.prototype['kind'] = undefined;

/**
 * @member {module:model/V1ObjectMeta} metadata
 */
V1alpha1ProjectClaim.prototype['metadata'] = undefined;

/**
 * @member {module:model/V1alpha1ProjectClaimSpec} spec
 */
V1alpha1ProjectClaim.prototype['spec'] = undefined;

/**
 * @member {module:model/V1alpha1ProjectClaimStatus} status
 */
V1alpha1ProjectClaim.prototype['status'] = undefined;
...
export default V1alpha1ProjectClaim;
