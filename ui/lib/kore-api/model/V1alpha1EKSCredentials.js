...
import V1alpha1EKSCredentialsSpec from './V1alpha1EKSCredentialsSpec';
import V1alpha1EKSCredentialsStatus from './V1alpha1EKSCredentialsStatus';

/**
 * The V1alpha1EKSCredentials model module.
 * @module model/V1alpha1EKSCredentials
 * @version 0.0.1
 */
class V1alpha1EKSCredentials {
    /**
     * Constructs a new <code>V1alpha1EKSCredentials</code>.
     * @alias module:model/V1alpha1EKSCredentials
     */
    constructor() { 
        
        V1alpha1EKSCredentials.initialize(this);
    }
    ...
    /**
     * Constructs a <code>V1alpha1EKSCredentials</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/V1alpha1EKSCredentials} obj Optional instance to populate.
     * @return {module:model/V1alpha1EKSCredentials} The populated <code>V1alpha1EKSCredentials</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new V1alpha1EKSCredentials();
            ...
            if (data.hasOwnProperty('spec')) {
                obj['spec'] = V1alpha1EKSCredentialsSpec.constructFromObject(data['spec']);
            }
            if (data.hasOwnProperty('status')) {
                obj['status'] = V1alpha1EKSCredentialsStatus.constructFromObject(data['status']);
            }
        }
        return obj;
    }
...
/**
     * @return {module:model/V1alpha1EKSCredentialsSpec}
     */
    getSpec() {
        return this.spec;
    }
    ...
    /**
     * @param {module:model/V1alpha1EKSCredentialsSpec} spec
     */
    setSpec(spec) {
        this['spec'] = spec;
    }
/**
     * @return {module:model/V1alpha1EKSCredentialsStatus}
     */
    getStatus() {
        return this.status;
    }
    ...
    /**
     * @param {module:model/V1alpha1EKSCredentialsStatus} status
     */
    setStatus(status) {
        this['status'] = status;
    }
 ...
 */
V1alpha1EKSCredentials.prototype['apiVersion'] = undefined;

/**
 * Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
 * @member {String} kind
 */
V1alpha1EKSCredentials.prototype['kind'] = undefined;

/**
 * @member {module:model/V1ObjectMeta} metadata
 */
V1alpha1EKSCredentials.prototype['metadata'] = undefined;

/**
 * @member {module:model/V1alpha1EKSCredentialsSpec} spec
 */
V1alpha1EKSCredentials.prototype['spec'] = undefined;

/**
 * @member {module:model/V1alpha1EKSCredentialsStatus} status
 */
V1alpha1EKSCredentials.prototype['status'] = undefined;
...
export default V1alpha1EKSCredentials;
