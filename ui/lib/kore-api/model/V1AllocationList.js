...
import V1Allocation from './V1Allocation';
import V1ListMeta from './V1ListMeta';

/**
 * The V1AllocationList model module.
 * @module model/V1AllocationList
 * @version 0.0.1
 */
class V1AllocationList {
    /**
     * Constructs a new <code>V1AllocationList</code>.
     * @alias module:model/V1AllocationList
     * @param items {Array.<module:model/V1Allocation>} 
     */
    constructor(items) { 
        
        V1AllocationList.initialize(this, items);
    }
    ...
    /**
     * Constructs a <code>V1AllocationList</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/V1AllocationList} obj Optional instance to populate.
     * @return {module:model/V1AllocationList} The populated <code>V1AllocationList</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new V1AllocationList();

            if (data.hasOwnProperty('apiVersion')) {
                obj['apiVersion'] = ApiClient.convertToType(data['apiVersion'], 'String');
            }
            if (data.hasOwnProperty('items')) {
                obj['items'] = ApiClient.convertToType(data['items'], [V1Allocation]);
            }
...
/**
     * @return {Array.<module:model/V1Allocation>}
     */
    getItems() {
        return this.items;
    }
    ...
    /**
     * @param {Array.<module:model/V1Allocation>} items
     */
    setItems(items) {
        this['items'] = items;
    }
 ...
 */
V1AllocationList.prototype['apiVersion'] = undefined;

/**
 * @member {Array.<module:model/V1Allocation>} items
 */
V1AllocationList.prototype['items'] = undefined;

/**
 * Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
 * @member {String} kind
 */
V1AllocationList.prototype['kind'] = undefined;

/**
 * @member {module:model/V1ListMeta} metadata
 */
V1AllocationList.prototype['metadata'] = undefined;
...
export default V1AllocationList;
