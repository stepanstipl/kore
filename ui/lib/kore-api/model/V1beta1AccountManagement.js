...
import V1beta1AccountManagementSpec from './V1beta1AccountManagementSpec';
import V1beta1AccountManagementStatus from './V1beta1AccountManagementStatus';

/**
 * The V1beta1AccountManagement model module.
 * @module model/V1beta1AccountManagement
 * @version 0.0.1
 */
class V1beta1AccountManagement {
    /**
     * Constructs a new <code>V1beta1AccountManagement</code>.
     * @alias module:model/V1beta1AccountManagement
     */
    constructor() { 
        
        V1beta1AccountManagement.initialize(this);
    }
    ...
    /**
     * Constructs a <code>V1beta1AccountManagement</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/V1beta1AccountManagement} obj Optional instance to populate.
     * @return {module:model/V1beta1AccountManagement} The populated <code>V1beta1AccountManagement</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new V1beta1AccountManagement();
            ...
            if (data.hasOwnProperty('spec')) {
                obj['spec'] = V1beta1AccountManagementSpec.constructFromObject(data['spec']);
            }
            if (data.hasOwnProperty('status')) {
                obj['status'] = V1beta1AccountManagementStatus.constructFromObject(data['status']);
            }
        }
        return obj;
    }
...
/**
     * @return {module:model/V1beta1AccountManagementSpec}
     */
    getSpec() {
        return this.spec;
    }
    ...
    /**
     * @param {module:model/V1beta1AccountManagementSpec} spec
     */
    setSpec(spec) {
        this['spec'] = spec;
    }
/**
     * @return {module:model/V1beta1AccountManagementStatus}
     */
    getStatus() {
        return this.status;
    }
    ...
    /**
     * @param {module:model/V1beta1AccountManagementStatus} status
     */
    setStatus(status) {
        this['status'] = status;
    }
 ...
 */
V1beta1AccountManagement.prototype['apiVersion'] = undefined;

/**
 * Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
 * @member {String} kind
 */
V1beta1AccountManagement.prototype['kind'] = undefined;

/**
 * @member {module:model/V1ObjectMeta} metadata
 */
V1beta1AccountManagement.prototype['metadata'] = undefined;

/**
 * @member {module:model/V1beta1AccountManagementSpec} spec
 */
V1beta1AccountManagement.prototype['spec'] = undefined;

/**
 * @member {module:model/V1beta1AccountManagementStatus} status
 */
V1beta1AccountManagement.prototype['status'] = undefined;
...
export default V1beta1AccountManagement;
