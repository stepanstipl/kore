...
import V1ServicePlan from './V1ServicePlan';

/**
 * The V1ServicePlanList model module.
 * @module model/V1ServicePlanList
 * @version 0.0.1
 */
class V1ServicePlanList {
    /**
     * Constructs a new <code>V1ServicePlanList</code>.
     * @alias module:model/V1ServicePlanList
     * @param items {Array.<module:model/V1ServicePlan>} 
     */
    constructor(items) { 
        
        V1ServicePlanList.initialize(this, items);
    }
    ...
    /**
     * Constructs a <code>V1ServicePlanList</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/V1ServicePlanList} obj Optional instance to populate.
     * @return {module:model/V1ServicePlanList} The populated <code>V1ServicePlanList</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new V1ServicePlanList();

            if (data.hasOwnProperty('apiVersion')) {
                obj['apiVersion'] = ApiClient.convertToType(data['apiVersion'], 'String');
            }
            if (data.hasOwnProperty('items')) {
                obj['items'] = ApiClient.convertToType(data['items'], [V1ServicePlan]);
            }
...
/**
     * @return {Array.<module:model/V1ServicePlan>}
     */
    getItems() {
        return this.items;
    }
    ...
    /**
     * @param {Array.<module:model/V1ServicePlan>} items
     */
    setItems(items) {
        this['items'] = items;
    }
 ...
 */
V1ServicePlanList.prototype['apiVersion'] = undefined;

/**
 * @member {Array.<module:model/V1ServicePlan>} items
 */
V1ServicePlanList.prototype['items'] = undefined;

/**
 * Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
 * @member {String} kind
 */
V1ServicePlanList.prototype['kind'] = undefined;

/**
 * @member {module:model/V1ListMeta} metadata
 */
V1ServicePlanList.prototype['metadata'] = undefined;
...
export default V1ServicePlanList;
