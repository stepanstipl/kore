...
import V1alpha1Organization from './V1alpha1Organization';

/**
 * The V1alpha1OrganizationList model module.
 * @module model/V1alpha1OrganizationList
 * @version 0.0.1
 */
class V1alpha1OrganizationList {
    /**
     * Constructs a new <code>V1alpha1OrganizationList</code>.
     * @alias module:model/V1alpha1OrganizationList
     * @param items {Array.<module:model/V1alpha1Organization>} 
     */
    constructor(items) { 
        
        V1alpha1OrganizationList.initialize(this, items);
    }
    ...
    /**
     * Constructs a <code>V1alpha1OrganizationList</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/V1alpha1OrganizationList} obj Optional instance to populate.
     * @return {module:model/V1alpha1OrganizationList} The populated <code>V1alpha1OrganizationList</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new V1alpha1OrganizationList();

            if (data.hasOwnProperty('apiVersion')) {
                obj['apiVersion'] = ApiClient.convertToType(data['apiVersion'], 'String');
            }
            if (data.hasOwnProperty('items')) {
                obj['items'] = ApiClient.convertToType(data['items'], [V1alpha1Organization]);
            }
...
/**
     * @return {Array.<module:model/V1alpha1Organization>}
     */
    getItems() {
        return this.items;
    }
    ...
    /**
     * @param {Array.<module:model/V1alpha1Organization>} items
     */
    setItems(items) {
        this['items'] = items;
    }
 ...
 */
V1alpha1OrganizationList.prototype['apiVersion'] = undefined;

/**
 * @member {Array.<module:model/V1alpha1Organization>} items
 */
V1alpha1OrganizationList.prototype['items'] = undefined;

/**
 * Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
 * @member {String} kind
 */
V1alpha1OrganizationList.prototype['kind'] = undefined;

/**
 * @member {module:model/V1ListMeta} metadata
 */
V1alpha1OrganizationList.prototype['metadata'] = undefined;
...
export default V1alpha1OrganizationList;
