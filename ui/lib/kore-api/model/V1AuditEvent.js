...
import V1AuditEventSpec from './V1AuditEventSpec';
import V1ObjectMeta from './V1ObjectMeta';

/**
 * The V1AuditEvent model module.
 * @module model/V1AuditEvent
 * @version 0.0.1
 */
class V1AuditEvent {
    /**
     * Constructs a new <code>V1AuditEvent</code>.
     * @alias module:model/V1AuditEvent
     */
    constructor() { 
        
        V1AuditEvent.initialize(this);
    }
    ...
    /**
     * Constructs a <code>V1AuditEvent</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/V1AuditEvent} obj Optional instance to populate.
     * @return {module:model/V1AuditEvent} The populated <code>V1AuditEvent</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new V1AuditEvent();
            ...
            if (data.hasOwnProperty('spec')) {
                obj['spec'] = V1AuditEventSpec.constructFromObject(data['spec']);
            }
        }
        return obj;
    }
...
/**
     * @return {module:model/V1AuditEventSpec}
     */
    getSpec() {
        return this.spec;
    }
    ...
    /**
     * @param {module:model/V1AuditEventSpec} spec
     */
    setSpec(spec) {
        this['spec'] = spec;
    }
 ...
 */
V1AuditEvent.prototype['apiVersion'] = undefined;

/**
 * Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
 * @member {String} kind
 */
V1AuditEvent.prototype['kind'] = undefined;

/**
 * @member {module:model/V1ObjectMeta} metadata
 */
V1AuditEvent.prototype['metadata'] = undefined;

/**
 * @member {module:model/V1AuditEventSpec} spec
 */
V1AuditEvent.prototype['spec'] = undefined;
