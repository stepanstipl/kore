...
import V1beta1AccountManagement from './V1beta1AccountManagement';

/**
 * The V1beta1AccountManagementList model module.
 * @module model/V1beta1AccountManagementList
 * @version 0.0.1
 */
class V1beta1AccountManagementList {
    /**
     * Constructs a new <code>V1beta1AccountManagementList</code>.
     * @alias module:model/V1beta1AccountManagementList
     * @param items {Array.<module:model/V1beta1AccountManagement>} 
     */
    constructor(items) { 
        
        V1beta1AccountManagementList.initialize(this, items);
    }
    ...
    /**
     * Constructs a <code>V1beta1AccountManagementList</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/V1beta1AccountManagementList} obj Optional instance to populate.
     * @return {module:model/V1beta1AccountManagementList} The populated <code>V1beta1AccountManagementList</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new V1beta1AccountManagementList();

            if (data.hasOwnProperty('apiVersion')) {
                obj['apiVersion'] = ApiClient.convertToType(data['apiVersion'], 'String');
            }
            if (data.hasOwnProperty('items')) {
                obj['items'] = ApiClient.convertToType(data['items'], [V1beta1AccountManagement]);
            }
...
/**
     * @return {Array.<module:model/V1beta1AccountManagement>}
     */
    getItems() {
        return this.items;
    }
    ...
    /**
     * @param {Array.<module:model/V1beta1AccountManagement>} items
     */
    setItems(items) {
        this['items'] = items;
    }
 ...
 */
V1beta1AccountManagementList.prototype['apiVersion'] = undefined;

/**
 * @member {Array.<module:model/V1beta1AccountManagement>} items
 */
V1beta1AccountManagementList.prototype['items'] = undefined;

/**
 * Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
 * @member {String} kind
 */
V1beta1AccountManagementList.prototype['kind'] = undefined;

/**
 * @member {module:model/V1ListMeta} metadata
 */
V1beta1AccountManagementList.prototype['metadata'] = undefined;
...
export default V1beta1AccountManagementList;
