...
/**
 * The V1ConfigList model module.
 * @module model/V1ConfigList
 * @version 0.0.1
 */
class V1ConfigList {
    /**
     * Constructs a new <code>V1ConfigList</code>.
     * @alias module:model/V1ConfigList
     * @param items {Array.<module:model/V1Config>} 
     */
    constructor(items) { 
        
        V1ConfigList.initialize(this, items);
    }
    ...
    /**
     * Constructs a <code>V1ConfigList</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/V1ConfigList} obj Optional instance to populate.
     * @return {module:model/V1ConfigList} The populated <code>V1ConfigList</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new V1ConfigList();

            if (data.hasOwnProperty('apiVersion')) {
                obj['apiVersion'] = ApiClient.convertToType(data['apiVersion'], 'String');
            }
            if (data.hasOwnProperty('items')) {
                obj['items'] = ApiClient.convertToType(data['items'], [V1Config]);
            }
...
/**
     * @return {Array.<module:model/V1Config>}
     */
    getItems() {
        return this.items;
    }
    ...
    /**
     * @param {Array.<module:model/V1Config>} items
     */
    setItems(items) {
        this['items'] = items;
    }
 ...
 */
V1ConfigList.prototype['apiVersion'] = undefined;

/**
 * @member {Array.<module:model/V1Config>} items
 */
V1ConfigList.prototype['items'] = undefined;

/**
 * Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
 * @member {String} kind
 */
V1ConfigList.prototype['kind'] = undefined;

/**
 * @member {module:model/V1ListMeta} metadata
 */
V1ConfigList.prototype['metadata'] = undefined;
