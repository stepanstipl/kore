...
import V1PlanStatus from './V1PlanStatus';

/**
 * The V1Plan model module.
 * @module model/V1Plan
 * @version 0.0.1
 */
class V1Plan {
 ...
 */
V1Plan.prototype['apiVersion'] = undefined;

/**
 * Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
 * @member {String} kind
 */
V1Plan.prototype['kind'] = undefined;

/**
 * @member {module:model/V1ObjectMeta} metadata
 */
V1Plan.prototype['metadata'] = undefined;

/**
 * @member {module:model/V1PlanSpec} spec
 */
V1Plan.prototype['spec'] = undefined;

/**
 * @member {module:model/V1PlanStatus} status
 */
V1Plan.prototype['status'] = undefined;
