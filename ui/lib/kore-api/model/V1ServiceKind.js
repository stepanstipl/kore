...
import V1ServiceKindSpec from './V1ServiceKindSpec';

/**
 * The V1ServiceKind model module.
 * @module model/V1ServiceKind
 * @version 0.0.1
 */
class V1ServiceKind {
    /**
     * Constructs a new <code>V1ServiceKind</code>.
     * @alias module:model/V1ServiceKind
     */
    constructor() { 
        
        V1ServiceKind.initialize(this);
    }
    ...
    /**
     * Constructs a <code>V1ServiceKind</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/V1ServiceKind} obj Optional instance to populate.
     * @return {module:model/V1ServiceKind} The populated <code>V1ServiceKind</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new V1ServiceKind();
            ...
            if (data.hasOwnProperty('spec')) {
                obj['spec'] = V1ServiceKindSpec.constructFromObject(data['spec']);
            }
        }
        return obj;
    }
...
/**
     * @return {module:model/V1ServiceKindSpec}
     */
    getSpec() {
        return this.spec;
    }
    ...
    /**
     * @param {module:model/V1ServiceKindSpec} spec
     */
    setSpec(spec) {
        this['spec'] = spec;
    }
 ...
 */
V1ServiceKind.prototype['apiVersion'] = undefined;

/**
 * Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
 * @member {String} kind
 */
V1ServiceKind.prototype['kind'] = undefined;

/**
 * @member {module:model/V1ObjectMeta} metadata
 */
V1ServiceKind.prototype['metadata'] = undefined;

/**
 * @member {module:model/V1ServiceKindSpec} spec
 */
V1ServiceKind.prototype['spec'] = undefined;
