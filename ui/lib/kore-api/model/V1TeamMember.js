...
import V1TeamMemberSpec from './V1TeamMemberSpec';
import V1TeamMemberStatus from './V1TeamMemberStatus';
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('spec')) {
                obj['spec'] = V1TeamMemberSpec.constructFromObject(data['spec']);
            }
            if (data.hasOwnProperty('status')) {
                obj['status'] = V1TeamMemberStatus.constructFromObject(data['status']);
            }
        }
        return obj;
    }
...
/**
     * @return {module:model/V1TeamMemberSpec}
     */
    getSpec() {
        return this.spec;
    }
    ...
    /**
     * @param {module:model/V1TeamMemberSpec} spec
     */
    setSpec(spec) {
        this['spec'] = spec;
    }
/**
     * @return {module:model/V1TeamMemberStatus}
     */
    getStatus() {
        return this.status;
    }
    ...
    /**
     * @param {module:model/V1TeamMemberStatus} status
     */
    setStatus(status) {
        this['status'] = status;
    }
 ...
 */
V1TeamMember.prototype['apiVersion'] = undefined;
 ...
 */
V1TeamMember.prototype['metadata'] = undefined;

/**
 * @member {module:model/V1TeamMemberSpec} spec
 */
V1TeamMember.prototype['spec'] = undefined;

/**
 * @member {module:model/V1TeamMemberStatus} status
 */
V1TeamMember.prototype['status'] = undefined;
