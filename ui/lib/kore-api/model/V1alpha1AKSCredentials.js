...
import V1alpha1AKSCredentialsSpec from './V1alpha1AKSCredentialsSpec';
import V1alpha1AKSCredentialsStatus from './V1alpha1AKSCredentialsStatus';

/**
 * The V1alpha1AKSCredentials model module.
 * @module model/V1alpha1AKSCredentials
 * @version 0.0.1
 */
class V1alpha1AKSCredentials {
    /**
     * Constructs a new <code>V1alpha1AKSCredentials</code>.
     * @alias module:model/V1alpha1AKSCredentials
     */
    constructor() { 
        
        V1alpha1AKSCredentials.initialize(this);
    }
    ...
    /**
     * Constructs a <code>V1alpha1AKSCredentials</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/V1alpha1AKSCredentials} obj Optional instance to populate.
     * @return {module:model/V1alpha1AKSCredentials} The populated <code>V1alpha1AKSCredentials</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new V1alpha1AKSCredentials();
            ...
            if (data.hasOwnProperty('spec')) {
                obj['spec'] = V1alpha1AKSCredentialsSpec.constructFromObject(data['spec']);
            }
            if (data.hasOwnProperty('status')) {
                obj['status'] = V1alpha1AKSCredentialsStatus.constructFromObject(data['status']);
            }
        }
        return obj;
    }
...
/**
     * @return {module:model/V1alpha1AKSCredentialsSpec}
     */
    getSpec() {
        return this.spec;
    }
    ...
    /**
     * @param {module:model/V1alpha1AKSCredentialsSpec} spec
     */
    setSpec(spec) {
        this['spec'] = spec;
    }
/**
     * @return {module:model/V1alpha1AKSCredentialsStatus}
     */
    getStatus() {
        return this.status;
    }
    ...
    /**
     * @param {module:model/V1alpha1AKSCredentialsStatus} status
     */
    setStatus(status) {
        this['status'] = status;
    }
 ...
 */
V1alpha1AKSCredentials.prototype['apiVersion'] = undefined;

/**
 * Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
 * @member {String} kind
 */
V1alpha1AKSCredentials.prototype['kind'] = undefined;

/**
 * @member {module:model/V1ObjectMeta} metadata
 */
V1alpha1AKSCredentials.prototype['metadata'] = undefined;

/**
 * @member {module:model/V1alpha1AKSCredentialsSpec} spec
 */
V1alpha1AKSCredentials.prototype['spec'] = undefined;

/**
 * @member {module:model/V1alpha1AKSCredentialsStatus} status
 */
V1alpha1AKSCredentials.prototype['status'] = undefined;
...
export default V1alpha1AKSCredentials;
