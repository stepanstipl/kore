...
import V1alpha1GKESpec from './V1alpha1GKESpec';
import V1alpha1GKEStatus from './V1alpha1GKEStatus';

/**
 * The V1alpha1GKE model module.
 * @module model/V1alpha1GKE
 * @version 0.0.1
 */
class V1alpha1GKE {
    /**
     * Constructs a new <code>V1alpha1GKE</code>.
     * @alias module:model/V1alpha1GKE
     */
    constructor() { 
        
        V1alpha1GKE.initialize(this);
    }
    ...
    /**
     * Constructs a <code>V1alpha1GKE</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/V1alpha1GKE} obj Optional instance to populate.
     * @return {module:model/V1alpha1GKE} The populated <code>V1alpha1GKE</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new V1alpha1GKE();
            ...
            if (data.hasOwnProperty('spec')) {
                obj['spec'] = V1alpha1GKESpec.constructFromObject(data['spec']);
            }
            if (data.hasOwnProperty('status')) {
                obj['status'] = V1alpha1GKEStatus.constructFromObject(data['status']);
            }
        }
        return obj;
    }
...
/**
     * @return {module:model/V1alpha1GKESpec}
     */
    getSpec() {
        return this.spec;
    }
    ...
    /**
     * @param {module:model/V1alpha1GKESpec} spec
     */
    setSpec(spec) {
        this['spec'] = spec;
    }
/**
     * @return {module:model/V1alpha1GKEStatus}
     */
    getStatus() {
        return this.status;
    }
    ...
    /**
     * @param {module:model/V1alpha1GKEStatus} status
     */
    setStatus(status) {
        this['status'] = status;
    }
 ...
 */
V1alpha1GKE.prototype['apiVersion'] = undefined;

/**
 * Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
 * @member {String} kind
 */
V1alpha1GKE.prototype['kind'] = undefined;

/**
 * @member {module:model/V1ObjectMeta} metadata
 */
V1alpha1GKE.prototype['metadata'] = undefined;

/**
 * @member {module:model/V1alpha1GKESpec} spec
 */
V1alpha1GKE.prototype['spec'] = undefined;

/**
 * @member {module:model/V1alpha1GKEStatus} status
 */
V1alpha1GKE.prototype['status'] = undefined;
