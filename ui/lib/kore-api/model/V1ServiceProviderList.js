...
import V1ServiceProvider from './V1ServiceProvider';

/**
 * The V1ServiceProviderList model module.
 * @module model/V1ServiceProviderList
 * @version 0.0.1
 */
class V1ServiceProviderList {
    /**
     * Constructs a new <code>V1ServiceProviderList</code>.
     * @alias module:model/V1ServiceProviderList
     * @param items {Array.<module:model/V1ServiceProvider>} 
     */
    constructor(items) { 
        
        V1ServiceProviderList.initialize(this, items);
    }
    ...
    /**
     * Constructs a <code>V1ServiceProviderList</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/V1ServiceProviderList} obj Optional instance to populate.
     * @return {module:model/V1ServiceProviderList} The populated <code>V1ServiceProviderList</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new V1ServiceProviderList();

            if (data.hasOwnProperty('apiVersion')) {
                obj['apiVersion'] = ApiClient.convertToType(data['apiVersion'], 'String');
            }
            if (data.hasOwnProperty('items')) {
                obj['items'] = ApiClient.convertToType(data['items'], [V1ServiceProvider]);
            }
...
/**
     * @return {Array.<module:model/V1ServiceProvider>}
     */
    getItems() {
        return this.items;
    }
    ...
    /**
     * @param {Array.<module:model/V1ServiceProvider>} items
     */
    setItems(items) {
        this['items'] = items;
    }
 ...
 */
V1ServiceProviderList.prototype['apiVersion'] = undefined;

/**
 * @member {Array.<module:model/V1ServiceProvider>} items
 */
V1ServiceProviderList.prototype['items'] = undefined;

/**
 * Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
 * @member {String} kind
 */
V1ServiceProviderList.prototype['kind'] = undefined;

/**
 * @member {module:model/V1ListMeta} metadata
 */
V1ServiceProviderList.prototype['metadata'] = undefined;
...
export default V1ServiceProviderList;
