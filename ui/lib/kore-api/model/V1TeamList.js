...
/**
 * The V1TeamList model module.
 * @module model/V1TeamList
 * @version 0.0.1
 */
class V1TeamList {
    /**
     * Constructs a new <code>V1TeamList</code>.
     * @alias module:model/V1TeamList
     * @param items {Array.<module:model/V1Team>} 
     */
    constructor(items) { 
        
        V1TeamList.initialize(this, items);
    }
    ...
    /**
     * Constructs a <code>V1TeamList</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/V1TeamList} obj Optional instance to populate.
     * @return {module:model/V1TeamList} The populated <code>V1TeamList</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new V1TeamList();

            if (data.hasOwnProperty('apiVersion')) {
                obj['apiVersion'] = ApiClient.convertToType(data['apiVersion'], 'String');
            }
            if (data.hasOwnProperty('items')) {
                obj['items'] = ApiClient.convertToType(data['items'], [V1Team]);
            }
...
/**
     * @return {Array.<module:model/V1Team>}
     */
    getItems() {
        return this.items;
    }
    ...
    /**
     * @param {Array.<module:model/V1Team>} items
     */
    setItems(items) {
        this['items'] = items;
    }
 ...
 */
V1TeamList.prototype['apiVersion'] = undefined;

/**
 * @member {Array.<module:model/V1Team>} items
 */
V1TeamList.prototype['items'] = undefined;

/**
 * Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
 * @member {String} kind
 */
V1TeamList.prototype['kind'] = undefined;

/**
 * @member {module:model/V1ListMeta} metadata
 */
V1TeamList.prototype['metadata'] = undefined;
