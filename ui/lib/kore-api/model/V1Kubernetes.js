...
import V1KubernetesSpec from './V1KubernetesSpec';
import V1KubernetesStatus from './V1KubernetesStatus';
import V1ObjectMeta from './V1ObjectMeta';

/**
 * The V1Kubernetes model module.
 * @module model/V1Kubernetes
 * @version 0.0.1
 */
class V1Kubernetes {
    /**
     * Constructs a new <code>V1Kubernetes</code>.
     * @alias module:model/V1Kubernetes
     */
    constructor() { 
        
        V1Kubernetes.initialize(this);
    }
    ...
    /**
     * Constructs a <code>V1Kubernetes</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/V1Kubernetes} obj Optional instance to populate.
     * @return {module:model/V1Kubernetes} The populated <code>V1Kubernetes</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new V1Kubernetes();
            ...
            if (data.hasOwnProperty('spec')) {
                obj['spec'] = V1KubernetesSpec.constructFromObject(data['spec']);
            }
            if (data.hasOwnProperty('status')) {
                obj['status'] = V1KubernetesStatus.constructFromObject(data['status']);
            }
        }
        return obj;
    }
...
/**
     * @return {module:model/V1KubernetesSpec}
     */
    getSpec() {
        return this.spec;
    }
    ...
    /**
     * @param {module:model/V1KubernetesSpec} spec
     */
    setSpec(spec) {
        this['spec'] = spec;
    }
/**
     * @return {module:model/V1KubernetesStatus}
     */
    getStatus() {
        return this.status;
    }
    ...
    /**
     * @param {module:model/V1KubernetesStatus} status
     */
    setStatus(status) {
        this['status'] = status;
    }
 ...
 */
V1Kubernetes.prototype['apiVersion'] = undefined;

/**
 * Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
 * @member {String} kind
 */
V1Kubernetes.prototype['kind'] = undefined;

/**
 * @member {module:model/V1ObjectMeta} metadata
 */
V1Kubernetes.prototype['metadata'] = undefined;

/**
 * @member {module:model/V1KubernetesSpec} spec
 */
V1Kubernetes.prototype['spec'] = undefined;

/**
 * @member {module:model/V1KubernetesStatus} status
 */
V1Kubernetes.prototype['status'] = undefined;
