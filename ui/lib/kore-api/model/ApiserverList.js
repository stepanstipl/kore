...
/**
 * The ApiserverList model module.
 * @module model/ApiserverList
 * @version 0.0.1
 */
class ApiserverList {
    /**
     * Constructs a new <code>ApiserverList</code>.
     * @alias module:model/ApiserverList
     * @param items {Array.<String>} 
     */
    constructor(items) { 
        
        ApiserverList.initialize(this, items);
    }
    ...
    /**
     * Constructs a <code>ApiserverList</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ApiserverList} obj Optional instance to populate.
     * @return {module:model/ApiserverList} The populated <code>ApiserverList</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ApiserverList();
 ...
 */
ApiserverList.prototype['apiVersion'] = undefined;

/**
 * @member {Array.<String>} items
 */
ApiserverList.prototype['items'] = undefined;

/**
 * Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
 * @member {String} kind
 */
ApiserverList.prototype['kind'] = undefined;

/**
 * @member {module:model/V1ListMeta} metadata
 */
ApiserverList.prototype['metadata'] = undefined;
