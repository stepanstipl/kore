...
import V1TeamInvitation from './V1TeamInvitation';

/**
 * The V1TeamInvitationList model module.
 * @module model/V1TeamInvitationList
 * @version 0.0.1
 */
class V1TeamInvitationList {
    /**
     * Constructs a new <code>V1TeamInvitationList</code>.
     * @alias module:model/V1TeamInvitationList
     * @param items {Array.<module:model/V1TeamInvitation>} 
     */
    constructor(items) { 
        
        V1TeamInvitationList.initialize(this, items);
    }
    ...
    /**
     * Constructs a <code>V1TeamInvitationList</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/V1TeamInvitationList} obj Optional instance to populate.
     * @return {module:model/V1TeamInvitationList} The populated <code>V1TeamInvitationList</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new V1TeamInvitationList();

            if (data.hasOwnProperty('apiVersion')) {
                obj['apiVersion'] = ApiClient.convertToType(data['apiVersion'], 'String');
            }
            if (data.hasOwnProperty('items')) {
                obj['items'] = ApiClient.convertToType(data['items'], [V1TeamInvitation]);
            }
...
/**
     * @return {Array.<module:model/V1TeamInvitation>}
     */
    getItems() {
        return this.items;
    }
    ...
    /**
     * @param {Array.<module:model/V1TeamInvitation>} items
     */
    setItems(items) {
        this['items'] = items;
    }
 ...
 */
V1TeamInvitationList.prototype['apiVersion'] = undefined;

/**
 * @member {Array.<module:model/V1TeamInvitation>} items
 */
V1TeamInvitationList.prototype['items'] = undefined;

/**
 * Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
 * @member {String} kind
 */
V1TeamInvitationList.prototype['kind'] = undefined;

/**
 * @member {module:model/V1ListMeta} metadata
 */
V1TeamInvitationList.prototype['metadata'] = undefined;
...
export default V1TeamInvitationList;
