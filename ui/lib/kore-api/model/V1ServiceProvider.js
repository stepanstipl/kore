...
import V1ServiceProviderSpec from './V1ServiceProviderSpec';
import V1ServiceProviderStatus from './V1ServiceProviderStatus';

/**
 * The V1ServiceProvider model module.
 * @module model/V1ServiceProvider
 * @version 0.0.1
 */
class V1ServiceProvider {
    /**
     * Constructs a new <code>V1ServiceProvider</code>.
     * @alias module:model/V1ServiceProvider
     */
    constructor() { 
        
        V1ServiceProvider.initialize(this);
    }
    ...
    /**
     * Constructs a <code>V1ServiceProvider</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/V1ServiceProvider} obj Optional instance to populate.
     * @return {module:model/V1ServiceProvider} The populated <code>V1ServiceProvider</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new V1ServiceProvider();
            ...
            if (data.hasOwnProperty('spec')) {
                obj['spec'] = V1ServiceProviderSpec.constructFromObject(data['spec']);
            }
            if (data.hasOwnProperty('status')) {
                obj['status'] = V1ServiceProviderStatus.constructFromObject(data['status']);
            }
        }
        return obj;
    }
...
/**
     * @return {module:model/V1ServiceProviderSpec}
     */
    getSpec() {
        return this.spec;
    }
    ...
    /**
     * @param {module:model/V1ServiceProviderSpec} spec
     */
    setSpec(spec) {
        this['spec'] = spec;
    }
/**
     * @return {module:model/V1ServiceProviderStatus}
     */
    getStatus() {
        return this.status;
    }
    ...
    /**
     * @param {module:model/V1ServiceProviderStatus} status
     */
    setStatus(status) {
        this['status'] = status;
    }
 ...
 */
V1ServiceProvider.prototype['apiVersion'] = undefined;

/**
 * Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
 * @member {String} kind
 */
V1ServiceProvider.prototype['kind'] = undefined;

/**
 * @member {module:model/V1ObjectMeta} metadata
 */
V1ServiceProvider.prototype['metadata'] = undefined;

/**
 * @member {module:model/V1ServiceProviderSpec} spec
 */
V1ServiceProvider.prototype['spec'] = undefined;

/**
 * @member {module:model/V1ServiceProviderStatus} status
 */
V1ServiceProvider.prototype['status'] = undefined;
...
export default V1ServiceProvider;
