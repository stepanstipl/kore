...
import V1alpha1AWSOrganizationSpec from './V1alpha1AWSOrganizationSpec';
import V1alpha1AWSOrganizationStatus from './V1alpha1AWSOrganizationStatus';

/**
 * The V1alpha1AWSOrganization model module.
 * @module model/V1alpha1AWSOrganization
 * @version 0.0.1
 */
class V1alpha1AWSOrganization {
    /**
     * Constructs a new <code>V1alpha1AWSOrganization</code>.
     * @alias module:model/V1alpha1AWSOrganization
     */
    constructor() { 
        
        V1alpha1AWSOrganization.initialize(this);
    }
    ...
    /**
     * Constructs a <code>V1alpha1AWSOrganization</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/V1alpha1AWSOrganization} obj Optional instance to populate.
     * @return {module:model/V1alpha1AWSOrganization} The populated <code>V1alpha1AWSOrganization</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new V1alpha1AWSOrganization();
            ...
            if (data.hasOwnProperty('spec')) {
                obj['spec'] = V1alpha1AWSOrganizationSpec.constructFromObject(data['spec']);
            }
            if (data.hasOwnProperty('status')) {
                obj['status'] = V1alpha1AWSOrganizationStatus.constructFromObject(data['status']);
            }
        }
        return obj;
    }
...
/**
     * @return {module:model/V1alpha1AWSOrganizationSpec}
     */
    getSpec() {
        return this.spec;
    }
    ...
    /**
     * @param {module:model/V1alpha1AWSOrganizationSpec} spec
     */
    setSpec(spec) {
        this['spec'] = spec;
    }
/**
     * @return {module:model/V1alpha1AWSOrganizationStatus}
     */
    getStatus() {
        return this.status;
    }
    ...
    /**
     * @param {module:model/V1alpha1AWSOrganizationStatus} status
     */
    setStatus(status) {
        this['status'] = status;
    }
 ...
 */
V1alpha1AWSOrganization.prototype['apiVersion'] = undefined;

/**
 * Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
 * @member {String} kind
 */
V1alpha1AWSOrganization.prototype['kind'] = undefined;

/**
 * @member {module:model/V1ObjectMeta} metadata
 */
V1alpha1AWSOrganization.prototype['metadata'] = undefined;

/**
 * @member {module:model/V1alpha1AWSOrganizationSpec} spec
 */
V1alpha1AWSOrganization.prototype['spec'] = undefined;

/**
 * @member {module:model/V1alpha1AWSOrganizationStatus} status
 */
V1alpha1AWSOrganization.prototype['status'] = undefined;
...
export default V1alpha1AWSOrganization;
