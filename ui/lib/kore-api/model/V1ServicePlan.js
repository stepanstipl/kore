...
/**
 * The V1ServicePlan model module.
 * @module model/V1ServicePlan
 * @version 0.0.1
 */
class V1ServicePlan {
    /**
     * Constructs a new <code>V1ServicePlan</code>.
     * @alias module:model/V1ServicePlan
     */
    constructor() { 
        
        V1ServicePlan.initialize(this);
    }
    ...
    /**
     * Constructs a <code>V1ServicePlan</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/V1ServicePlan} obj Optional instance to populate.
     * @return {module:model/V1ServicePlan} The populated <code>V1ServicePlan</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new V1ServicePlan();
            ...
            if (data.hasOwnProperty('spec')) {
                obj['spec'] = V1ServicePlanSpec.constructFromObject(data['spec']);
            }
        }
        return obj;
    }
...
/**
    ...
    /**
     * @param {module:model/V1ServicePlanSpec} spec
     */
    setSpec(spec) {
        this['spec'] = spec;
    }
 ...
 */
V1ServicePlan.prototype['apiVersion'] = undefined;

/**
 * Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
 * @member {String} kind
 */
V1ServicePlan.prototype['kind'] = undefined;

/**
 * @member {module:model/V1ObjectMeta} metadata
 */
V1ServicePlan.prototype['metadata'] = undefined;

/**
 * @member {module:model/V1ServicePlanSpec} spec
 */
V1ServicePlan.prototype['spec'] = undefined;
