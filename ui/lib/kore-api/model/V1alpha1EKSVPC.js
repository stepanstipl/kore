...
import V1alpha1EKSVPCSpec from './V1alpha1EKSVPCSpec';
import V1alpha1EKSVPCStatus from './V1alpha1EKSVPCStatus';

/**
 * The V1alpha1EKSVPC model module.
 * @module model/V1alpha1EKSVPC
 * @version 0.0.1
 */
class V1alpha1EKSVPC {
    /**
     * Constructs a new <code>V1alpha1EKSVPC</code>.
     * @alias module:model/V1alpha1EKSVPC
     */
    constructor() { 
        
        V1alpha1EKSVPC.initialize(this);
    }
    ...
    /**
     * Constructs a <code>V1alpha1EKSVPC</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/V1alpha1EKSVPC} obj Optional instance to populate.
     * @return {module:model/V1alpha1EKSVPC} The populated <code>V1alpha1EKSVPC</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new V1alpha1EKSVPC();
            ...
            if (data.hasOwnProperty('spec')) {
                obj['spec'] = V1alpha1EKSVPCSpec.constructFromObject(data['spec']);
            }
            if (data.hasOwnProperty('status')) {
                obj['status'] = V1alpha1EKSVPCStatus.constructFromObject(data['status']);
            }
        }
        return obj;
    }
...
/**
     * @return {module:model/V1alpha1EKSVPCSpec}
     */
    getSpec() {
        return this.spec;
    }
    ...
    /**
     * @param {module:model/V1alpha1EKSVPCSpec} spec
     */
    setSpec(spec) {
        this['spec'] = spec;
    }
/**
     * @return {module:model/V1alpha1EKSVPCStatus}
     */
    getStatus() {
        return this.status;
    }
    ...
    /**
     * @param {module:model/V1alpha1EKSVPCStatus} status
     */
    setStatus(status) {
        this['status'] = status;
    }
 ...
 */
V1alpha1EKSVPC.prototype['apiVersion'] = undefined;

/**
 * Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
 * @member {String} kind
 */
V1alpha1EKSVPC.prototype['kind'] = undefined;

/**
 * @member {module:model/V1ObjectMeta} metadata
 */
V1alpha1EKSVPC.prototype['metadata'] = undefined;

/**
 * @member {module:model/V1alpha1EKSVPCSpec} spec
 */
V1alpha1EKSVPC.prototype['spec'] = undefined;

/**
 * @member {module:model/V1alpha1EKSVPCStatus} status
 */
V1alpha1EKSVPC.prototype['status'] = undefined;
