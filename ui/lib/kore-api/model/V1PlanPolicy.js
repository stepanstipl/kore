...
import V1PlanPolicySpec from './V1PlanPolicySpec';
import V1PlanPolicyStatus from './V1PlanPolicyStatus';

/**
 * The V1PlanPolicy model module.
 * @module model/V1PlanPolicy
 * @version 0.0.1
 */
class V1PlanPolicy {
    /**
     * Constructs a new <code>V1PlanPolicy</code>.
     * @alias module:model/V1PlanPolicy
     */
    constructor() { 
        
        V1PlanPolicy.initialize(this);
    }
    ...
    /**
     * Constructs a <code>V1PlanPolicy</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/V1PlanPolicy} obj Optional instance to populate.
     * @return {module:model/V1PlanPolicy} The populated <code>V1PlanPolicy</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new V1PlanPolicy();
            ...
            if (data.hasOwnProperty('spec')) {
                obj['spec'] = V1PlanPolicySpec.constructFromObject(data['spec']);
            }
            if (data.hasOwnProperty('status')) {
                obj['status'] = V1PlanPolicyStatus.constructFromObject(data['status']);
            }
        }
        return obj;
    }
...
/**
     * @return {module:model/V1PlanPolicySpec}
     */
    getSpec() {
        return this.spec;
    }
    ...
    /**
     * @param {module:model/V1PlanPolicySpec} spec
     */
    setSpec(spec) {
        this['spec'] = spec;
    }
/**
     * @return {module:model/V1PlanPolicyStatus}
     */
    getStatus() {
        return this.status;
    }
    ...
    /**
     * @param {module:model/V1PlanPolicyStatus} status
     */
    setStatus(status) {
        this['status'] = status;
    }
 ...
 */
V1PlanPolicy.prototype['apiVersion'] = undefined;

/**
 * Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
 * @member {String} kind
 */
V1PlanPolicy.prototype['kind'] = undefined;

/**
 * @member {module:model/V1ObjectMeta} metadata
 */
V1PlanPolicy.prototype['metadata'] = undefined;

/**
 * @member {module:model/V1PlanPolicySpec} spec
 */
V1PlanPolicy.prototype['spec'] = undefined;

/**
 * @member {module:model/V1PlanPolicyStatus} status
 */
V1PlanPolicy.prototype['status'] = undefined;
