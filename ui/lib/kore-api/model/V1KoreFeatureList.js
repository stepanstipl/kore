...
import V1KoreFeature from './V1KoreFeature';
import V1ListMeta from './V1ListMeta';

/**
 * The V1KoreFeatureList model module.
 * @module model/V1KoreFeatureList
 * @version 0.0.1
 */
class V1KoreFeatureList {
    /**
     * Constructs a new <code>V1KoreFeatureList</code>.
     * @alias module:model/V1KoreFeatureList
     * @param items {Array.<module:model/V1KoreFeature>} 
     */
    constructor(items) { 
        
        V1KoreFeatureList.initialize(this, items);
    }
    ...
    /**
     * Constructs a <code>V1KoreFeatureList</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/V1KoreFeatureList} obj Optional instance to populate.
     * @return {module:model/V1KoreFeatureList} The populated <code>V1KoreFeatureList</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new V1KoreFeatureList();

            if (data.hasOwnProperty('apiVersion')) {
                obj['apiVersion'] = ApiClient.convertToType(data['apiVersion'], 'String');
            }
            if (data.hasOwnProperty('items')) {
                obj['items'] = ApiClient.convertToType(data['items'], [V1KoreFeature]);
            }
...
/**
     * @return {Array.<module:model/V1KoreFeature>}
     */
    getItems() {
        return this.items;
    }
    ...
    /**
     * @param {Array.<module:model/V1KoreFeature>} items
     */
    setItems(items) {
        this['items'] = items;
    }
 ...
 */
V1KoreFeatureList.prototype['apiVersion'] = undefined;

/**
 * @member {Array.<module:model/V1KoreFeature>} items
 */
V1KoreFeatureList.prototype['items'] = undefined;

/**
 * Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
 * @member {String} kind
 */
V1KoreFeatureList.prototype['kind'] = undefined;

/**
 * @member {module:model/V1ListMeta} metadata
 */
V1KoreFeatureList.prototype['metadata'] = undefined;
...
export default V1KoreFeatureList;
