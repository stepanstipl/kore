...
import V1alpha1OrganizationSpec from './V1alpha1OrganizationSpec';
import V1alpha1OrganizationStatus from './V1alpha1OrganizationStatus';

/**
 * The V1alpha1Organization model module.
 * @module model/V1alpha1Organization
 * @version 0.0.1
 */
class V1alpha1Organization {
    /**
     * Constructs a new <code>V1alpha1Organization</code>.
     * @alias module:model/V1alpha1Organization
     */
    constructor() { 
        
        V1alpha1Organization.initialize(this);
    }
    ...
    /**
     * Constructs a <code>V1alpha1Organization</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/V1alpha1Organization} obj Optional instance to populate.
     * @return {module:model/V1alpha1Organization} The populated <code>V1alpha1Organization</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new V1alpha1Organization();
            ...
            if (data.hasOwnProperty('spec')) {
                obj['spec'] = V1alpha1OrganizationSpec.constructFromObject(data['spec']);
            }
            if (data.hasOwnProperty('status')) {
                obj['status'] = V1alpha1OrganizationStatus.constructFromObject(data['status']);
            }
        }
        return obj;
    }
...
/**
     * @return {module:model/V1alpha1OrganizationSpec}
     */
    getSpec() {
        return this.spec;
    }
    ...
    /**
     * @param {module:model/V1alpha1OrganizationSpec} spec
     */
    setSpec(spec) {
        this['spec'] = spec;
    }
/**
     * @return {module:model/V1alpha1OrganizationStatus}
     */
    getStatus() {
        return this.status;
    }
    ...
    /**
     * @param {module:model/V1alpha1OrganizationStatus} status
     */
    setStatus(status) {
        this['status'] = status;
    }
 ...
 */
V1alpha1Organization.prototype['apiVersion'] = undefined;

/**
 * Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
 * @member {String} kind
 */
V1alpha1Organization.prototype['kind'] = undefined;

/**
 * @member {module:model/V1ObjectMeta} metadata
 */
V1alpha1Organization.prototype['metadata'] = undefined;

/**
 * @member {module:model/V1alpha1OrganizationSpec} spec
 */
V1alpha1Organization.prototype['spec'] = undefined;

/**
 * @member {module:model/V1alpha1OrganizationStatus} status
 */
V1alpha1Organization.prototype['status'] = undefined;
...
export default V1alpha1Organization;
