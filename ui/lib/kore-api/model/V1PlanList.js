...
import V1Plan from './V1Plan';

/**
 * The V1PlanList model module.
 * @module model/V1PlanList
 * @version 0.0.1
 */
class V1PlanList {
    /**
     * Constructs a new <code>V1PlanList</code>.
     * @alias module:model/V1PlanList
     * @param items {Array.<module:model/V1Plan>} 
     */
    constructor(items) { 
        
        V1PlanList.initialize(this, items);
    }
    ...
    /**
     * Constructs a <code>V1PlanList</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/V1PlanList} obj Optional instance to populate.
     * @return {module:model/V1PlanList} The populated <code>V1PlanList</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new V1PlanList();

            if (data.hasOwnProperty('apiVersion')) {
                obj['apiVersion'] = ApiClient.convertToType(data['apiVersion'], 'String');
            }
            if (data.hasOwnProperty('items')) {
                obj['items'] = ApiClient.convertToType(data['items'], [V1Plan]);
            }
...
/**
     * @return {Array.<module:model/V1Plan>}
     */
    getItems() {
        return this.items;
    }
    ...
    /**
     * @param {Array.<module:model/V1Plan>} items
     */
    setItems(items) {
        this['items'] = items;
    }
 ...
 */
V1PlanList.prototype['apiVersion'] = undefined;

/**
 * @member {Array.<module:model/V1Plan>} items
 */
V1PlanList.prototype['items'] = undefined;

/**
 * Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
 * @member {String} kind
 */
V1PlanList.prototype['kind'] = undefined;

/**
 * @member {module:model/V1ListMeta} metadata
 */
V1PlanList.prototype['metadata'] = undefined;
