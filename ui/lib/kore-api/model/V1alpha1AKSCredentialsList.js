...
import V1alpha1AKSCredentials from './V1alpha1AKSCredentials';

/**
 * The V1alpha1AKSCredentialsList model module.
 * @module model/V1alpha1AKSCredentialsList
 * @version 0.0.1
 */
class V1alpha1AKSCredentialsList {
    /**
     * Constructs a new <code>V1alpha1AKSCredentialsList</code>.
     * @alias module:model/V1alpha1AKSCredentialsList
     * @param items {Array.<module:model/V1alpha1AKSCredentials>} 
     */
    constructor(items) { 
        
        V1alpha1AKSCredentialsList.initialize(this, items);
    }
    ...
    /**
     * Constructs a <code>V1alpha1AKSCredentialsList</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/V1alpha1AKSCredentialsList} obj Optional instance to populate.
     * @return {module:model/V1alpha1AKSCredentialsList} The populated <code>V1alpha1AKSCredentialsList</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new V1alpha1AKSCredentialsList();

            if (data.hasOwnProperty('apiVersion')) {
                obj['apiVersion'] = ApiClient.convertToType(data['apiVersion'], 'String');
            }
            if (data.hasOwnProperty('items')) {
                obj['items'] = ApiClient.convertToType(data['items'], [V1alpha1AKSCredentials]);
            }
...
/**
     * @return {Array.<module:model/V1alpha1AKSCredentials>}
     */
    getItems() {
        return this.items;
    }
    ...
    /**
     * @param {Array.<module:model/V1alpha1AKSCredentials>} items
     */
    setItems(items) {
        this['items'] = items;
    }
 ...
 */
V1alpha1AKSCredentialsList.prototype['apiVersion'] = undefined;

/**
 * @member {Array.<module:model/V1alpha1AKSCredentials>} items
 */
V1alpha1AKSCredentialsList.prototype['items'] = undefined;

/**
 * Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
 * @member {String} kind
 */
V1alpha1AKSCredentialsList.prototype['kind'] = undefined;

/**
 * @member {module:model/V1ListMeta} metadata
 */
V1alpha1AKSCredentialsList.prototype['metadata'] = undefined;
...
export default V1alpha1AKSCredentialsList;
