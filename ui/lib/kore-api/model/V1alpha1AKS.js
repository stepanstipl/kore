...
import V1alpha1AKSSpec from './V1alpha1AKSSpec';
import V1alpha1AKSStatus from './V1alpha1AKSStatus';

/**
 * The V1alpha1AKS model module.
 * @module model/V1alpha1AKS
 * @version 0.0.1
 */
class V1alpha1AKS {
    /**
     * Constructs a new <code>V1alpha1AKS</code>.
     * @alias module:model/V1alpha1AKS
     */
    constructor() { 
        
        V1alpha1AKS.initialize(this);
    }
    ...
    /**
     * Constructs a <code>V1alpha1AKS</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/V1alpha1AKS} obj Optional instance to populate.
     * @return {module:model/V1alpha1AKS} The populated <code>V1alpha1AKS</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new V1alpha1AKS();
            ...
            if (data.hasOwnProperty('spec')) {
                obj['spec'] = V1alpha1AKSSpec.constructFromObject(data['spec']);
            }
            if (data.hasOwnProperty('status')) {
                obj['status'] = V1alpha1AKSStatus.constructFromObject(data['status']);
            }
        }
        return obj;
    }
...
/**
     * @return {module:model/V1alpha1AKSSpec}
     */
    getSpec() {
        return this.spec;
    }
    ...
    /**
     * @param {module:model/V1alpha1AKSSpec} spec
     */
    setSpec(spec) {
        this['spec'] = spec;
    }
/**
     * @return {module:model/V1alpha1AKSStatus}
     */
    getStatus() {
        return this.status;
    }
    ...
    /**
     * @param {module:model/V1alpha1AKSStatus} status
     */
    setStatus(status) {
        this['status'] = status;
    }
 ...
 */
V1alpha1AKS.prototype['apiVersion'] = undefined;

/**
 * Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
 * @member {String} kind
 */
V1alpha1AKS.prototype['kind'] = undefined;

/**
 * @member {module:model/V1ObjectMeta} metadata
 */
V1alpha1AKS.prototype['metadata'] = undefined;

/**
 * @member {module:model/V1alpha1AKSSpec} spec
 */
V1alpha1AKS.prototype['spec'] = undefined;

/**
 * @member {module:model/V1alpha1AKSStatus} status
 */
V1alpha1AKS.prototype['status'] = undefined;
