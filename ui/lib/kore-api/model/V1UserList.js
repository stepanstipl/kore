...
/**
 * The V1UserList model module.
 * @module model/V1UserList
 * @version 0.0.1
 */
class V1UserList {
    /**
     * Constructs a new <code>V1UserList</code>.
     * @alias module:model/V1UserList
     * @param items {Array.<module:model/V1User>} 
     */
    constructor(items) { 
        
        V1UserList.initialize(this, items);
    }
    ...
    /**
     * Constructs a <code>V1UserList</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/V1UserList} obj Optional instance to populate.
     * @return {module:model/V1UserList} The populated <code>V1UserList</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new V1UserList();

            if (data.hasOwnProperty('apiVersion')) {
                obj['apiVersion'] = ApiClient.convertToType(data['apiVersion'], 'String');
            }
            if (data.hasOwnProperty('items')) {
                obj['items'] = ApiClient.convertToType(data['items'], [V1User]);
            }
...
/**
     * @return {Array.<module:model/V1User>}
     */
    getItems() {
        return this.items;
    }
    ...
    /**
     * @param {Array.<module:model/V1User>} items
     */
    setItems(items) {
        this['items'] = items;
    }
 ...
 */
V1UserList.prototype['apiVersion'] = undefined;

/**
 * @member {Array.<module:model/V1User>} items
 */
V1UserList.prototype['items'] = undefined;

/**
 * Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
 * @member {String} kind
 */
V1UserList.prototype['kind'] = undefined;

/**
 * @member {module:model/V1ListMeta} metadata
 */
V1UserList.prototype['metadata'] = undefined;
