...
import V1alpha1ProjectClaim from './V1alpha1ProjectClaim';

/**
 * The V1alpha1ProjectClaimList model module.
 * @module model/V1alpha1ProjectClaimList
 * @version 0.0.1
 */
class V1alpha1ProjectClaimList {
    /**
     * Constructs a new <code>V1alpha1ProjectClaimList</code>.
     * @alias module:model/V1alpha1ProjectClaimList
     * @param items {Array.<module:model/V1alpha1ProjectClaim>} 
     */
    constructor(items) { 
        
        V1alpha1ProjectClaimList.initialize(this, items);
    }
    ...
    /**
     * Constructs a <code>V1alpha1ProjectClaimList</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/V1alpha1ProjectClaimList} obj Optional instance to populate.
     * @return {module:model/V1alpha1ProjectClaimList} The populated <code>V1alpha1ProjectClaimList</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new V1alpha1ProjectClaimList();

            if (data.hasOwnProperty('apiVersion')) {
                obj['apiVersion'] = ApiClient.convertToType(data['apiVersion'], 'String');
            }
            if (data.hasOwnProperty('items')) {
                obj['items'] = ApiClient.convertToType(data['items'], [V1alpha1ProjectClaim]);
            }
...
/**
     * @return {Array.<module:model/V1alpha1ProjectClaim>}
     */
    getItems() {
        return this.items;
    }
    ...
    /**
     * @param {Array.<module:model/V1alpha1ProjectClaim>} items
     */
    setItems(items) {
        this['items'] = items;
    }
 ...
 */
V1alpha1ProjectClaimList.prototype['apiVersion'] = undefined;

/**
 * @member {Array.<module:model/V1alpha1ProjectClaim>} items
 */
V1alpha1ProjectClaimList.prototype['items'] = undefined;

/**
 * Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
 * @member {String} kind
 */
V1alpha1ProjectClaimList.prototype['kind'] = undefined;

/**
 * @member {module:model/V1ListMeta} metadata
 */
V1alpha1ProjectClaimList.prototype['metadata'] = undefined;
...
export default V1alpha1ProjectClaimList;
