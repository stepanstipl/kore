...
import V1SecurityRule from './V1SecurityRule';

/**
 * The V1SecurityRuleList model module.
 * @module model/V1SecurityRuleList
 * @version 0.0.1
 */
class V1SecurityRuleList {
    /**
     * Constructs a new <code>V1SecurityRuleList</code>.
     * @alias module:model/V1SecurityRuleList
     * @param items {Array.<module:model/V1SecurityRule>} 
     */
    constructor(items) { 
        
        V1SecurityRuleList.initialize(this, items);
    }
    ...
    /**
     * Constructs a <code>V1SecurityRuleList</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/V1SecurityRuleList} obj Optional instance to populate.
     * @return {module:model/V1SecurityRuleList} The populated <code>V1SecurityRuleList</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new V1SecurityRuleList();

            if (data.hasOwnProperty('apiVersion')) {
                obj['apiVersion'] = ApiClient.convertToType(data['apiVersion'], 'String');
            }
            if (data.hasOwnProperty('items')) {
                obj['items'] = ApiClient.convertToType(data['items'], [V1SecurityRule]);
            }
...
/**
     * @return {Array.<module:model/V1SecurityRule>}
     */
    getItems() {
        return this.items;
    }
    ...
    /**
     * @param {Array.<module:model/V1SecurityRule>} items
     */
    setItems(items) {
        this['items'] = items;
    }
 ...
 */
V1SecurityRuleList.prototype['apiVersion'] = undefined;

/**
 * @member {Array.<module:model/V1SecurityRule>} items
 */
V1SecurityRuleList.prototype['items'] = undefined;

/**
 * Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
 * @member {String} kind
 */
V1SecurityRuleList.prototype['kind'] = undefined;

/**
 * @member {module:model/V1ListMeta} metadata
 */
V1SecurityRuleList.prototype['metadata'] = undefined;
...
export default V1SecurityRuleList;
