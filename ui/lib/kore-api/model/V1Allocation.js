...
import V1AllocationSpec from './V1AllocationSpec';
import V1AllocationStatus from './V1AllocationStatus';
import V1ObjectMeta from './V1ObjectMeta';

/**
 * The V1Allocation model module.
 * @module model/V1Allocation
 * @version 0.0.1
 */
class V1Allocation {
    /**
     * Constructs a new <code>V1Allocation</code>.
     * @alias module:model/V1Allocation
     */
    constructor() { 
        
        V1Allocation.initialize(this);
    }
    ...
    /**
     * Constructs a <code>V1Allocation</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/V1Allocation} obj Optional instance to populate.
     * @return {module:model/V1Allocation} The populated <code>V1Allocation</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new V1Allocation();
            ...
            if (data.hasOwnProperty('spec')) {
                obj['spec'] = V1AllocationSpec.constructFromObject(data['spec']);
            }
            if (data.hasOwnProperty('status')) {
                obj['status'] = V1AllocationStatus.constructFromObject(data['status']);
            }
        }
        return obj;
    }
...
/**
     * @return {module:model/V1AllocationSpec}
     */
    getSpec() {
        return this.spec;
    }
    ...
    /**
     * @param {module:model/V1AllocationSpec} spec
     */
    setSpec(spec) {
        this['spec'] = spec;
    }
/**
     * @return {module:model/V1AllocationStatus}
     */
    getStatus() {
        return this.status;
    }
    ...
    /**
     * @param {module:model/V1AllocationStatus} status
     */
    setStatus(status) {
        this['status'] = status;
    }
 ...
 */
V1Allocation.prototype['apiVersion'] = undefined;

/**
 * Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
 * @member {String} kind
 */
V1Allocation.prototype['kind'] = undefined;

/**
 * @member {module:model/V1ObjectMeta} metadata
 */
V1Allocation.prototype['metadata'] = undefined;

/**
 * @member {module:model/V1AllocationSpec} spec
 */
V1Allocation.prototype['spec'] = undefined;

/**
 * @member {module:model/V1AllocationStatus} status
 */
V1Allocation.prototype['status'] = undefined;
