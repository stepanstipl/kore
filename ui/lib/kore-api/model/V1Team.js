...
import V1TeamSpec from './V1TeamSpec';
import V1TeamStatus from './V1TeamStatus';
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('spec')) {
                obj['spec'] = V1TeamSpec.constructFromObject(data['spec']);
            }
            if (data.hasOwnProperty('status')) {
                obj['status'] = V1TeamStatus.constructFromObject(data['status']);
            }
        }
        return obj;
    }
...
/**
     * @return {module:model/V1TeamSpec}
     */
    getSpec() {
        return this.spec;
    }
    ...
    /**
     * @param {module:model/V1TeamSpec} spec
     */
    setSpec(spec) {
        this['spec'] = spec;
    }
/**
     * @return {module:model/V1TeamStatus}
     */
    getStatus() {
        return this.status;
    }
    ...
    /**
     * @param {module:model/V1TeamStatus} status
     */
    setStatus(status) {
        this['status'] = status;
    }
 ...
 */
V1Team.prototype['apiVersion'] = undefined;

/**
 * Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
 * @member {String} kind
 */
V1Team.prototype['kind'] = undefined;

/**
 * @member {module:model/V1ObjectMeta} metadata
 */
V1Team.prototype['metadata'] = undefined;

/**
 * @member {module:model/V1TeamSpec} spec
 */
V1Team.prototype['spec'] = undefined;

/**
 * @member {module:model/V1TeamStatus} status
 */
V1Team.prototype['status'] = undefined;
