...
import V1SecurityScanResult from './V1SecurityScanResult';

/**
 * The V1SecurityScanResultList model module.
 * @module model/V1SecurityScanResultList
 * @version 0.0.1
 */
class V1SecurityScanResultList {
    /**
     * Constructs a new <code>V1SecurityScanResultList</code>.
     * @alias module:model/V1SecurityScanResultList
     * @param items {Array.<module:model/V1SecurityScanResult>} 
     */
    constructor(items) { 
        
        V1SecurityScanResultList.initialize(this, items);
    }
    ...
    /**
     * Constructs a <code>V1SecurityScanResultList</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/V1SecurityScanResultList} obj Optional instance to populate.
     * @return {module:model/V1SecurityScanResultList} The populated <code>V1SecurityScanResultList</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new V1SecurityScanResultList();

            if (data.hasOwnProperty('apiVersion')) {
                obj['apiVersion'] = ApiClient.convertToType(data['apiVersion'], 'String');
            }
            if (data.hasOwnProperty('items')) {
                obj['items'] = ApiClient.convertToType(data['items'], [V1SecurityScanResult]);
            }
...
/**
     * @return {Array.<module:model/V1SecurityScanResult>}
     */
    getItems() {
        return this.items;
    }
    ...
    /**
     * @param {Array.<module:model/V1SecurityScanResult>} items
     */
    setItems(items) {
        this['items'] = items;
    }
 ...
 */
V1SecurityScanResultList.prototype['apiVersion'] = undefined;

/**
 * @member {Array.<module:model/V1SecurityScanResult>} items
 */
V1SecurityScanResultList.prototype['items'] = undefined;

/**
 * Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
 * @member {String} kind
 */
V1SecurityScanResultList.prototype['kind'] = undefined;

/**
 * @member {module:model/V1ListMeta} metadata
 */
V1SecurityScanResultList.prototype['metadata'] = undefined;
...
export default V1SecurityScanResultList;
