...
/**
 * The V1OIDCIDP model module.
 * @module model/V1OIDCIDP
 * @version 0.0.1
 */
class V1OIDCIDP {
    /**
     * Constructs a new <code>V1OIDCIDP</code>.
     * @alias module:model/V1OIDCIDP
    ...
    constructor(clientID, clientScopes, clientSecret, issuer, userClaims) { 
        ...
        V1OIDCIDP.initialize(this, clientID, clientScopes, clientSecret, issuer, userClaims);
    }
    ...
    /**
     * Constructs a <code>V1OIDCIDP</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/V1OIDCIDP} obj Optional instance to populate.
     * @return {module:model/V1OIDCIDP} The populated <code>V1OIDCIDP</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new V1OIDCIDP();
 ...
 */
V1OIDCIDP.prototype['clientID'] = undefined;

/**
 * @member {Array.<String>} clientScopes
 */
V1OIDCIDP.prototype['clientScopes'] = undefined;

/**
 * @member {String} clientSecret
 */
V1OIDCIDP.prototype['clientSecret'] = undefined;

/**
 * @member {String} issuer
 */
V1OIDCIDP.prototype['issuer'] = undefined;

/**
 * @member {Array.<String>} userClaims
 */
V1OIDCIDP.prototype['userClaims'] = undefined;
