        ...
        spec:
          ...
          properties:
            apiServerAuthorizedIPRanges:
              description: APIServerAuthorizedIPRanges are IP ranges to whitelist
                for incoming traffic to the API servers
              items:
                type: string
              type: array
              x-kubernetes-list-type: set
            ...
            nodePools:
              ...
              items:
                description: AKSNodePool represents a node pool within a GKE cluster
                properties:
                  diskSize:
            ...
            privateClusterEnabled:
              description: PrivateClusterEnabled controls whether the Kubernetes API
                is only exposed on the private network
              type: boolean
            region:
              description: Region is the location where the AKS cluster should be
                created
              minLength: 1
              type: string
            version:
