...
func (o *UpdateClusterOK) GetPayload() *apimodels.V1Kubernetes {
	return o.Payload
}
...
func (o *UpdateClusterBadRequest) GetPayload() *apimodels.ValidationErrValidation {
	return o.Payload
}
...
func (o *UpdateClusterInternalServerError) GetPayload() *apimodels.ApiserverError {
	return o.Payload
}
