...
type UpdateTeamParams struct {
	...
	/*Body
	  Contains the definition for a team in the kore

	*/
	Body *apimodels.V1Team
	/*Team
...
func (o *UpdateTeamParams) WithBody(body *apimodels.V1Team) *UpdateTeamParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the update team params
func (o *UpdateTeamParams) SetBody(body *apimodels.V1Team) {
	o.Body = body
}

// WithTeam adds the team to the update team params
func (o *UpdateTeamParams) WithTeam(team string) *UpdateTeamParams {
	o.SetTeam(team)
	return o
}

// SetTeam adds the team to the update team params
func (o *UpdateTeamParams) SetTeam(team string) {
	o.Team = team
}
