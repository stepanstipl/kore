...
func (o *UpdateUserOK) GetPayload() *apimodels.V1User {
	return o.Payload
}
...
func (o *UpdateUserBadRequest) GetPayload() *apimodels.ValidationErrValidation {
	return o.Payload
}
...
func (o *UpdateUserInternalServerError) GetPayload() *apimodels.ApiserverError {
	return o.Payload
}
