...
func (o *UpdateClusterParams) WithBody(body *apimodels.V1Kubernetes) *UpdateClusterParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the update cluster params
func (o *UpdateClusterParams) SetBody(body *apimodels.V1Kubernetes) {
	o.Body = body
}
