...
type ListAuditEventsOK struct {
	Payload *apimodels.V1AuditEventList
}
...
func (o *ListAuditEventsOK) GetPayload() *apimodels.V1AuditEventList {
	return o.Payload
}
...
func (o *ListAuditEventsOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
	...
	o.Payload = new(apimodels.V1AuditEventList)
...
type ListAuditEventsBadRequest struct {
	Payload *apimodels.ValidationErrValidation
}
...
func (o *ListAuditEventsBadRequest) GetPayload() *apimodels.ValidationErrValidation {
	return o.Payload
}
...
func (o *ListAuditEventsBadRequest) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
	...
	o.Payload = new(apimodels.ValidationErrValidation)
...
func (o *ListAuditEventsInternalServerError) GetPayload() *apimodels.ApiserverError {
	return o.Payload
}
