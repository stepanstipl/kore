...
type ListUserTeamsParams struct {
	...
	/*User
	  The name of the user whos team membership you wish to see
...
// WithUser adds the user to the list user teams params
func (o *ListUserTeamsParams) WithUser(user string) *ListUserTeamsParams {
	o.SetUser(user)
	return o
}

// SetUser adds the user to the list user teams params
func (o *ListUserTeamsParams) SetUser(user string) {
	o.User = user
}
