...
type UpdateNamespaceParams struct {
	...
	*/
	Body *apimodels.V1NamespaceClaim
	/*Name
...
func (o *UpdateNamespaceParams) WithBody(body *apimodels.V1NamespaceClaim) *UpdateNamespaceParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the update namespace params
func (o *UpdateNamespaceParams) SetBody(body *apimodels.V1NamespaceClaim) {
	o.Body = body
}
