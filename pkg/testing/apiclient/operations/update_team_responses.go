...
func (o *UpdateTeamOK) GetPayload() *apimodels.V1Team {
	return o.Payload
}
...
func (o *UpdateTeamNotModified) GetPayload() *apimodels.V1Team {
	return o.Payload
}
...
func (o *UpdateTeamBadRequest) GetPayload() *apimodels.ValidationErrValidation {
	return o.Payload
}
...
func (o *UpdateTeamInternalServerError) GetPayload() *apimodels.ApiserverError {
	return o.Payload
}
