...
// WithTeam adds the team to the list clusters params
func (o *ListClustersParams) WithTeam(team string) *ListClustersParams {
	o.SetTeam(team)
	return o
}

// SetTeam adds the team to the list clusters params
func (o *ListClustersParams) SetTeam(team string) {
	o.Team = team
}
