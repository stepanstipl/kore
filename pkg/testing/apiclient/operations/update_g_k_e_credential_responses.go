...
func (o *UpdateGKECredentialOK) GetPayload() *apimodels.V1alpha1GKECredentials {
	return o.Payload
}
...
func (o *UpdateGKECredentialInternalServerError) GetPayload() *apimodels.ApiserverError {
	return o.Payload
}
