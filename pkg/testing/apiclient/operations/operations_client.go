...
type ClientService interface {
	...
	ListKubernetesCredentials(params *ListKubernetesCredentialsParams, authInfo runtime.ClientAuthInfoWriter) (*ListKubernetesCredentialsOK, error)
	...
	RemoveKubernetesCredential(params *RemoveKubernetesCredentialParams, authInfo runtime.ClientAuthInfoWriter) (*RemoveKubernetesCredentialOK, error)
	...
	UpdateKubernetesCredential(params *UpdateKubernetesCredentialParams, authInfo runtime.ClientAuthInfoWriter) (*UpdateKubernetesCredentialOK, error)
...
/*
  GetKubernetesCredential useds to retrieve specific kubernetes credentials within a team
*/
func (a *Client) GetKubernetesCredential(params *GetKubernetesCredentialParams, authInfo runtime.ClientAuthInfoWriter) (*GetKubernetesCredentialOK, error) {
	...
	result, err := a.transport.Submit(&runtime.ClientOperation{
		...
		Method:             "GET",
		PathPattern:        "/api/v1alpha1/teams/{team}/kubernetescredentials/{name}",
		ProducesMediaTypes: []string{"application/json"},
		ConsumesMediaTypes: []string{"application/json"},
		Schemes:            []string{"http"},
		Params:             params,
...
/*
  ListKubernetesCredentials useds to retrieve all kubernetes credentials for a team
*/
func (a *Client) ListKubernetesCredentials(params *ListKubernetesCredentialsParams, authInfo runtime.ClientAuthInfoWriter) (*ListKubernetesCredentialsOK, error) {
	// TODO: Validate the params before sending
	if params == nil {
		params = NewListKubernetesCredentialsParams()
	}

	result, err := a.transport.Submit(&runtime.ClientOperation{
		ID:                 "ListKubernetesCredentials",
		Method:             "GET",
		PathPattern:        "/api/v1alpha1/teams/{team}/kubernetescredentials",
		ProducesMediaTypes: []string{"application/json"},
		ConsumesMediaTypes: []string{"application/json"},
		Schemes:            []string{"http"},
		Params:             params,
		Reader:             &ListKubernetesCredentialsReader{formats: a.formats},
		AuthInfo:           authInfo,
		Context:            params.Context,
		Client:             params.HTTPClient,
	})
	...
	success, ok := result.(*ListKubernetesCredentialsOK)
	if ok {
		return success, nil
	}
	// unexpected success response
	// safeguard: normally, absent a default response, unknown success responses return an error above: so this is a codegen issue
	msg := fmt.Sprintf("unexpected success response for ListKubernetesCredentials: API contract not enforced by server. Client expected to get an error, but got: %T", result)
	panic(msg)
}
...
/*
  RemoveKubernetesCredential useds to return the cluster definition from the kore
*/
func (a *Client) RemoveKubernetesCredential(params *RemoveKubernetesCredentialParams, authInfo runtime.ClientAuthInfoWriter) (*RemoveKubernetesCredentialOK, error) {
	// TODO: Validate the params before sending
	if params == nil {
		params = NewRemoveKubernetesCredentialParams()
	}

	result, err := a.transport.Submit(&runtime.ClientOperation{
		ID:                 "RemoveKubernetesCredential",
		Method:             "DELETE",
		PathPattern:        "/api/v1alpha1/teams/{team}/kubernetescredentials/{name}",
		ProducesMediaTypes: []string{"application/json"},
		ConsumesMediaTypes: []string{"application/json"},
		Schemes:            []string{"http"},
		Params:             params,
		Reader:             &RemoveKubernetesCredentialReader{formats: a.formats},
		AuthInfo:           authInfo,
		Context:            params.Context,
		Client:             params.HTTPClient,
	})
	...
	success, ok := result.(*RemoveKubernetesCredentialOK)
	if ok {
		return success, nil
	}
	// unexpected success response
	// safeguard: normally, absent a default response, unknown success responses return an error above: so this is a codegen issue
	msg := fmt.Sprintf("unexpected success response for RemoveKubernetesCredential: API contract not enforced by server. Client expected to get an error, but got: %T", result)
	panic(msg)
}
...
/*
  UpdateKubernetesCredential useds to create update specific kubernetes credentials within a team
*/
func (a *Client) UpdateKubernetesCredential(params *UpdateKubernetesCredentialParams, authInfo runtime.ClientAuthInfoWriter) (*UpdateKubernetesCredentialOK, error) {
	// TODO: Validate the params before sending
	if params == nil {
	...
	success, ok := result.(*UpdateKubernetesCredentialOK)
	if ok {
		return success, nil
	}
	// unexpected success response
	// safeguard: normally, absent a default response, unknown success responses return an error above: so this is a codegen issue
	msg := fmt.Sprintf("unexpected success response for UpdateKubernetesCredential: API contract not enforced by server. Client expected to get an error, but got: %T", result)
	panic(msg)
}
