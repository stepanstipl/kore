...
func (o *AddTeamMemberOK) GetPayload() *apimodels.V1TeamMember {
	return o.Payload
}
...
func (o *AddTeamMemberBadRequest) GetPayload() *apimodels.ValidationErrValidation {
	return o.Payload
}
...
func (o *AddTeamMemberInternalServerError) GetPayload() *apimodels.ApiserverError {
	return o.Payload
}
