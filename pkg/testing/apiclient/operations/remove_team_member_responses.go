...
type RemoveTeamMemberOK struct {
	Payload *apimodels.V1TeamMember
}
...
func (o *RemoveTeamMemberOK) GetPayload() *apimodels.V1TeamMember {
	return o.Payload
}
...
func (o *RemoveTeamMemberOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
	...
	o.Payload = new(apimodels.V1TeamMember)
...
func (o *RemoveTeamMemberInternalServerError) GetPayload() *apimodels.ApiserverError {
	return o.Payload
}
