...
const (
	ComponentProviderSecret   = "Provider secret"
	ComponentKubernetesSecret = "Kubernetes secret"
)
...
func (c *Controller) RunWithDependencies(ctx context.Context, mgr manager.Manager, ctrl controller.Controller, hi kore.Interface) error {
	...
	if err := c.ctrl.Watch(&source.Kind{Type: &servicesv1.ServiceCredentials{}}, &handler.EnqueueRequestForObject{}); err != nil {
