...
func (c *Controller) EnsureDeleting(claim *aws.AWSAccountClaim) controllers.EnsureFunc {
...
func (c *Controller) EnsureFinalizerRemoved(claim *aws.AWSAccountClaim) controllers.EnsureFunc {
	return func(ctx kore.Context) (reconcile.Result, error) {
