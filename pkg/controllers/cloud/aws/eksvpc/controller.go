...
func (t *eksvpcCtrl) Name() string {
	return "eksvpc"
}

// Run starts the controller
func (t *eksvpcCtrl) Run(ctx context.Context, cfg *rest.Config, hubi kore.Interface) error {
	...
	if err := ctrl.Watch(&source.Kind{Type: &eks.EKSVPC{}},
...
func (t *eksvpcCtrl) Stop(_ context.Context) error {
