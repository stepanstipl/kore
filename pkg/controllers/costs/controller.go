...
// Controller exposes the cost controller
...
// NewController creates and returns a costs controller
...
// RunWithDependencies executes the controller
func (a *Controller) RunWithDependencies(ctx context.Context, mgr manager.Manager, ctrl controller.Controller, hi kore.Interface) error {
	...
	if err := a.ctrl.Watch(
		&source.Kind{Type: &costsv1.Cost{}},
		&handler.EnqueueRequestForObject{},
		predicate.GenerationChangedPredicate{},
	); err != nil {

		a.logger.WithError(err).Error("failed to create watcher on cost resource")
