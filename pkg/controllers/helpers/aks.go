...
// CreateClustersClient creates and AKS Cluster API client
func (a *AKSHelper) CreateClustersClient(ctx kore.Context) (containerservice.ManagedClustersClient, error) {
...
func (a *AKSHelper) CreateResourceGroupsClient(ctx kore.Context) (resources.GroupsClient, error) {
	...
	client := resources.NewGroupsClient(creds.subscriptionID)
	client.Authorizer = authorizer
