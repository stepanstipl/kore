...
type ListAccountsParams struct {
	...
	/*Kind
	  Returns all accounts for a specific resource type
...
// WithKind adds the kind to the list accounts params
func (o *ListAccountsParams) WithKind(kind *string) *ListAccountsParams {
	o.SetKind(kind)
	return o
}

// SetKind adds the kind to the list accounts params
func (o *ListAccountsParams) SetKind(kind *string) {
	o.Kind = kind
}
