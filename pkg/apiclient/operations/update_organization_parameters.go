...
// WithName adds the name to the update organization params
func (o *UpdateOrganizationParams) WithName(name string) *UpdateOrganizationParams {
	o.SetName(name)
	return o
}

// SetName adds the name to the update organization params
func (o *UpdateOrganizationParams) SetName(name string) {
	o.Name = name
}

// WithTeam adds the team to the update organization params
func (o *UpdateOrganizationParams) WithTeam(team string) *UpdateOrganizationParams {
	o.SetTeam(team)
	return o
}

// SetTeam adds the team to the update organization params
func (o *UpdateOrganizationParams) SetTeam(team string) {
	o.Team = team
}
