...
type ListNamespacesOK struct {
	Payload *models.V1NamespaceClaimList
}
...
func (o *ListNamespacesOK) GetPayload() *models.V1NamespaceClaimList {
	return o.Payload
}
...
func (o *ListNamespacesOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
	...
	o.Payload = new(models.V1NamespaceClaimList)
...
func (o *ListNamespacesInternalServerError) GetPayload() *models.ApiserverError {
	return o.Payload
}
