...
func (o *UpdateConfigParams) WithBody(body *models.V1Config) *UpdateConfigParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the update config params
func (o *UpdateConfigParams) SetBody(body *models.V1Config) {
	o.Body = body
}

// WithConfig adds the config to the update config params
func (o *UpdateConfigParams) WithConfig(config string) *UpdateConfigParams {
	o.SetConfig(config)
	return o
}

// SetConfig adds the config to the update config params
func (o *UpdateConfigParams) SetConfig(config string) {
	o.Config = config
}
