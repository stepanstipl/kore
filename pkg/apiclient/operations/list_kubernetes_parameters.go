...
// WithTeam adds the team to the list kubernetes params
func (o *ListKubernetesParams) WithTeam(team string) *ListKubernetesParams {
	o.SetTeam(team)
	return o
}

// SetTeam adds the team to the list kubernetes params
func (o *ListKubernetesParams) SetTeam(team string) {
	o.Team = team
}
