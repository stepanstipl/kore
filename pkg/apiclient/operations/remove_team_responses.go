...
func (o *RemoveTeamOK) GetPayload() *models.V1Team {
	return o.Payload
}
...
func (o *RemoveTeamNotAcceptable) GetPayload() *models.ApiserverError {
	return o.Payload
}
...
func (o *RemoveTeamInternalServerError) GetPayload() *models.ApiserverError {
	return o.Payload
}
