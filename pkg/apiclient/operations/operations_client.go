...
type ClientService interface {
	...
	GetTeamServicePlanDetails(params *GetTeamServicePlanDetailsParams, authInfo runtime.ClientAuthInfoWriter) (*GetTeamServicePlanDetailsOK, error)
...
func (a *Client) GetSecurityRule(params *GetSecurityRuleParams, authInfo runtime.ClientAuthInfoWriter) (*GetSecurityRuleOK, error) {
	...
	result, err := a.transport.Submit(&runtime.ClientOperation{
		ID:                 "GetSecurityRule",
		Method:             "GET",
		PathPattern:        "/api/v1alpha1/security/rules/{code}",
		ProducesMediaTypes: []string{"application/json"},
		ConsumesMediaTypes: []string{"application/json"},
		Schemes:            []string{"http"},
		Params:             params,
...
func (a *Client) GetSecurityScan(params *GetSecurityScanParams, authInfo runtime.ClientAuthInfoWriter) (*GetSecurityScanOK, error) {
	...
	result, err := a.transport.Submit(&runtime.ClientOperation{
		ID:                 "GetSecurityScan",
		Method:             "GET",
		PathPattern:        "/api/v1alpha1/security/scans/{id}",
		ProducesMediaTypes: []string{"application/json"},
		ConsumesMediaTypes: []string{"application/json"},
		Schemes:            []string{"http"},
		Params:             params,
...
/*
  GetServicePlanSchema returns a specific service plan schema from the kore
*/
func (a *Client) GetServicePlanSchema(params *GetServicePlanSchemaParams, authInfo runtime.ClientAuthInfoWriter) (*GetServicePlanSchemaOK, error) {
	...
	result, err := a.transport.Submit(&runtime.ClientOperation{
		...
		Method:             "GET",
		PathPattern:        "/api/v1alpha1/serviceplanschemas/{name}",
		ProducesMediaTypes: []string{"application/json"},
		ConsumesMediaTypes: []string{"application/json"},
		Schemes:            []string{"http"},
		Params:             params,
...
/*
  GetTeamServicePlanDetails returns the plan the JSON schema of the plan and what what parameters are allowed to be edited by this team when using the plan
*/
func (a *Client) GetTeamServicePlanDetails(params *GetTeamServicePlanDetailsParams, authInfo runtime.ClientAuthInfoWriter) (*GetTeamServicePlanDetailsOK, error) {
	// TODO: Validate the params before sending
	if params == nil {
		params = NewGetTeamServicePlanDetailsParams()
	}

	result, err := a.transport.Submit(&runtime.ClientOperation{
		ID:                 "GetTeamServicePlanDetails",
		Method:             "GET",
		PathPattern:        "/api/v1alpha1/teams/{team}/serviceplans/{plan}",
		ProducesMediaTypes: []string{"application/json"},
		ConsumesMediaTypes: []string{"application/json"},
		Schemes:            []string{"http"},
		Params:             params,
		Reader:             &GetTeamServicePlanDetailsReader{formats: a.formats},
		AuthInfo:           authInfo,
		Context:            params.Context,
		Client:             params.HTTPClient,
	})
	...
	success, ok := result.(*GetTeamServicePlanDetailsOK)
	if ok {
		return success, nil
	}
	// unexpected success response
	// safeguard: normally, absent a default response, unknown success responses return an error above: so this is a codegen issue
	msg := fmt.Sprintf("unexpected success response for GetTeamServicePlanDetails: API contract not enforced by server. Client expected to get an error, but got: %T", result)
	panic(msg)
}
...
func (a *Client) ListSecurityRules(params *ListSecurityRulesParams, authInfo runtime.ClientAuthInfoWriter) (*ListSecurityRulesOK, error) {
	...
	result, err := a.transport.Submit(&runtime.ClientOperation{
		...
		Method:             "GET",
		PathPattern:        "/api/v1alpha1/security/rules",
		ProducesMediaTypes: []string{"application/json"},
		ConsumesMediaTypes: []string{"application/json"},
		Schemes:            []string{"http"},
		Params:             params,
...
func (a *Client) ListSecurityScans(params *ListSecurityScansParams, authInfo runtime.ClientAuthInfoWriter) (*ListSecurityScansOK, error) {
	...
	result, err := a.transport.Submit(&runtime.ClientOperation{
		...
		Method:             "GET",
		PathPattern:        "/api/v1alpha1/security/scans",
		ProducesMediaTypes: []string{"application/json"},
		ConsumesMediaTypes: []string{"application/json"},
		Schemes:            []string{"http"},
		Params:             params,
...
func (a *Client) ListSecurityScansForResource(params *ListSecurityScansForResourceParams, authInfo runtime.ClientAuthInfoWriter) (*ListSecurityScansForResourceOK, error) {
	...
	result, err := a.transport.Submit(&runtime.ClientOperation{
		...
		Method:             "GET",
		PathPattern:        "/api/v1alpha1/security/scans/{group}/{version}/{kind}/{namespace}/{name}/history",
		ProducesMediaTypes: []string{"application/json"},
		ConsumesMediaTypes: []string{"application/json"},
		Schemes:            []string{"http"},
		Params:             params,
