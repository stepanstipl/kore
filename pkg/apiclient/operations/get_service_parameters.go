...
// WithTeam adds the team to the get service params
func (o *GetServiceParams) WithTeam(team string) *GetServiceParams {
	o.SetTeam(team)
	return o
}

// SetTeam adds the team to the get service params
func (o *GetServiceParams) SetTeam(team string) {
	o.Team = team
}
