...
// WithName adds the name to the get namespace params
func (o *GetNamespaceParams) WithName(name string) *GetNamespaceParams {
	o.SetName(name)
	return o
}

// SetName adds the name to the get namespace params
func (o *GetNamespaceParams) SetName(name string) {
	o.Name = name
}

// WithTeam adds the team to the get namespace params
func (o *GetNamespaceParams) WithTeam(team string) *GetNamespaceParams {
	o.SetTeam(team)
	return o
}

// SetTeam adds the team to the get namespace params
func (o *GetNamespaceParams) SetTeam(team string) {
	o.Team = team
}
