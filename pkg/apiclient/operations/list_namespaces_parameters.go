...
// WithTeam adds the team to the list namespaces params
func (o *ListNamespacesParams) WithTeam(team string) *ListNamespacesParams {
	o.SetTeam(team)
	return o
}

// SetTeam adds the team to the list namespaces params
func (o *ListNamespacesParams) SetTeam(team string) {
	o.Team = team
}
