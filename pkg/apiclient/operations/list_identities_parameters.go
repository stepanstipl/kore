...
type ListIdentitiesParams struct {
	...
	/*All
	  returns all identities managed in kore

	*/
	All *bool
	/*Type
	  set the type of identities to retrieve
...
// WithAll adds the all to the list identities params
func (o *ListIdentitiesParams) WithAll(all *bool) *ListIdentitiesParams {
	o.SetAll(all)
	return o
}

// SetAll adds the all to the list identities params
func (o *ListIdentitiesParams) SetAll(all *bool) {
	o.All = all
}

// WithType adds the typeVar to the list identities params
func (o *ListIdentitiesParams) WithType(typeVar *string) *ListIdentitiesParams {
	o.SetType(typeVar)
	return o
}

// SetType adds the type to the list identities params
func (o *ListIdentitiesParams) SetType(typeVar *string) {
	o.Type = typeVar
}
