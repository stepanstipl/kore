...
type GetConfigParams struct {
	...
	/*Config
	  The name of the config you wish to retrieve
...
// WithConfig adds the config to the get config params
func (o *GetConfigParams) WithConfig(config string) *GetConfigParams {
	o.SetConfig(config)
	return o
}

// SetConfig adds the config to the get config params
func (o *GetConfigParams) SetConfig(config string) {
	o.Config = config
}
