...
func (m *V1User) validateMetadata(formats strfmt.Registry) error {
...
func (m *V1User) validateSpec(formats strfmt.Registry) error {
...
func (m *V1User) validateStatus(formats strfmt.Registry) error {
