...
type V1Kubernetes struct {
	...
	// spec
	Spec *V1KubernetesSpec `json:"spec,omitempty"`

	// status
	Status *V1KubernetesStatus `json:"status,omitempty"`
}
...
func (m *V1Kubernetes) validateMetadata(formats strfmt.Registry) error {
...
func (m *V1Kubernetes) validateSpec(formats strfmt.Registry) error {
...
func (m *V1Kubernetes) validateStatus(formats strfmt.Registry) error {
