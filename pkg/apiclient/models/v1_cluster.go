...
func (m *V1Cluster) validateMetadata(formats strfmt.Registry) error {
...
func (m *V1Cluster) validateSpec(formats strfmt.Registry) error {
...
func (m *V1Cluster) validateStatus(formats strfmt.Registry) error {
