...
// V1UserStatus v1 user status
//
// swagger:model v1.UserStatus
...
func (m *V1UserStatus) validateConditions(formats strfmt.Registry) error {
...
func (m *V1UserStatus) validateStatus(formats strfmt.Registry) error {
