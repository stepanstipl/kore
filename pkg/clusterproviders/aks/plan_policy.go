...
var planPolicy = configv1.PlanPolicy{
	...
	Spec: configv1.PlanPolicySpec{
		Kind:        Kind,
		Summary:     "Default plan policy for AKS clusters",
		Description: "This policy defines which plan properties can be edited by default for AKS clusters",
		Properties: []configv1.PlanPolicyProperty{
			...
			{Name: "dnsPrefix", AllowUpdate: true},
