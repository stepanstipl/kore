...
func (fake *FakeIDToken) Claims(arg1 interface{}) error {
...
func (fake *FakeIDToken) ClaimsCallCount() int {
	fake.claimsMutex.RLock()
	defer fake.claimsMutex.RUnlock()
	return len(fake.claimsArgsForCall)
}

func (fake *FakeIDToken) ClaimsCalls(stub func(interface{}) error) {
	fake.claimsMutex.Lock()
	defer fake.claimsMutex.Unlock()
	fake.ClaimsStub = stub
}

func (fake *FakeIDToken) ClaimsArgsForCall(i int) interface{} {
	fake.claimsMutex.RLock()
	defer fake.claimsMutex.RUnlock()
...
func (fake *FakeIDToken) ClaimsReturns(result1 error) {
	fake.claimsMutex.Lock()
	defer fake.claimsMutex.Unlock()
	fake.ClaimsStub = nil
...
func (fake *FakeIDToken) ClaimsReturnsOnCall(i int, result1 error) {
	fake.claimsMutex.Lock()
	defer fake.claimsMutex.Unlock()
	fake.ClaimsStub = nil
...
func (fake *FakeIDToken) Invocations() map[string][][]interface{} {
...
func (fake *FakeIDToken) recordInvocation(key string, args []interface{}) {
...
var _ openid.IDToken = new(FakeIDToken)
