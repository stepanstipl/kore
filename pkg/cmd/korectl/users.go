...
func GetUsersCommands(config *Config) cli.Command {
	return cli.Command{
		Name:    "users",
		Aliases: []string{"us"},
		Usage:   "Used to get, list, update and delete users in the kore",

		Subcommands: []cli.Command{
			{
				Name:  "get",
				Usage: "Used to retrieve one of more users from the kore",
			...
			},
			{
				Name:    "delete",
				Aliases: []string{"rm"},
				Usage:   "Used to delete a user from the kore",
				Flags: []cli.Flag{
					cli.StringFlag{
						Name:     "name,n",
