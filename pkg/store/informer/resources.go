...
func ResourceVersions() map[string]schema.GroupVersionResource {
	return map[string]schema.GroupVersionResource{
		...
		// ConfigV1
		NiceVersion(configv1.SchemeGroupVersion.WithResource("classes")): configv1.SchemeGroupVersion.WithResource("classes"),
		NiceVersion(configv1.SchemeGroupVersion.WithResource("plans")):   configv1.SchemeGroupVersion.WithResource("plans"),
		...
		NiceVersion(krbacv1.SchemeGroupVersion.WithResource("clusterrolebindings")):                    krbacv1.SchemeGroupVersion.WithResource("clusterrolebindings"),
		NiceVersion(krbacv1.SchemeGroupVersion.WithResource("clusterroles")):                           krbacv1.SchemeGroupVersion.WithResource("clusterroles"),
		NiceVersion(krbacv1.SchemeGroupVersion.WithResource("rolebindings")):                           krbacv1.SchemeGroupVersion.WithResource("rolebindings"),
		NiceVersion(krbacv1.SchemeGroupVersion.WithResource("roles")):                                  krbacv1.SchemeGroupVersion.WithResource("roles"),
...
// ToSchema converts the resource to a schema
func ToSchema(resource string) (schema.GroupVersionResource, error) {
	s := schema.GroupVersionResource{}

	switch items := strings.Split(resource, "/"); len(items) {
	case 2:
		s.Resource = items[1]
		s.Version = items[0]
	case 3:
		...
		s.Version = items[1]
	default:
		return s, errors.New("invalid resource definition")
	}
