...
// EKSCredentials is the gke interface
type EKSCredentials interface {
	// Delete is responsible for deleting a gke environment
	Delete(context.Context, string) error
	// Get return the definition from the api
	Get(context.Context, string) (*eks.EKSCredentials, error)
	// List returns all the gke cluster in the team
	List(context.Context) (*eks.EKSCredentialsList, error)
	// Update is used to update the gke cluster definition
	Update(context.Context, *eks.EKSCredentials) (*eks.EKSCredentials, error)
}

type eksCredsImpl struct {
	*cloudImpl
...
// Delete is responsible for deleting a gke environment
func (h *eksCredsImpl) Delete(ctx context.Context, name string) error {
